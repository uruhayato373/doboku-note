 ...
 *
 * 出力: .local/r2/posts/pe-comprehensive-management/frequent-topics/article.mdx
 *
...
const KEYWORD_2026 = `${ROOT}.local/r2/posts/pe-comprehensive-management/keyword-2026/article.mdx`;
const OUT = `${ROOT}.local/r2/posts/pe-comprehensive-management/frequent-topics/article.mdx`;
