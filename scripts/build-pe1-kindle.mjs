// 技術士第一次試験の完全解説 MDX（content/site/pe-first-stage/**）を
// 科目別7年分合本の Kindle 用 EPUB に変換する決定的ビルダー（Dシリーズ）。
// 戦略・価格の真実源: content/kindle/strategy.md
//
// 使い方:
...
//     "sources": ["content/site/pe-first-stage/r01-aptitude/article.mdx", ...],
//     "frontMatter": "content/kindle/books/d-02/front-matter.md"   // 書き下ろし前付け（任意だが出版時は必須）
//   }
//
// MDX → XHTML 変換:
