...
/**
 * ブログタイトルの最大長。**2026-08-12 時点で実機未計測**。
 * Phase 1 プローブ（/mypage/blogs/add?kind=1 の maxlength 実測）で数値を入れ、
 * このコメントに計測日を残すこと。null の間は長さ検査を「未実施」として報告する。
 */
export const TITLE_MAX = null;
