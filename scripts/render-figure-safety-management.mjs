#!/usr/bin/env node
// content/note/技術士総監/magazines/総監テキスト精読ガイド/5管理-安全管理/img/ に本文用 PNG/SVG 図版 11 枚を生成する。
//
...
const OUT_DIR = join(ROOT, 'content/note/技術士総監/magazines/総監テキスト精読ガイド/5管理-安全管理/img');
