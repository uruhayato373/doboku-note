 ...
 *
 * 総監標準テキスト5管理（docs/textbook/技術士（総監）/テキスト/総監標準テキスト/）の
...
// ---- paths ----------------------------------------------------------------
const TEXTBOOK_DIR = path.join(ROOT, 'docs/textbook/技術士（総監）/テキスト/総監標準テキスト');
...
const PE_POSTS_DIR = path.join(ROOT, '.local/r2/posts/pe-comprehensive-management');
