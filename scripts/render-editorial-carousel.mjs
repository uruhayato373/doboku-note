 ...
 *
 * 対象: docs/sns/instagram/{category}/{pack-dir}/slide-data.json (series: "A", editorial)
 * 出力: docs/sns/instagram/{category}/{pack-dir}/carousel/img/00-cover.png ...
 *
 * Usage:
 *   node scripts/render-editorial-carousel.mjs \
 *     --pack-dir docs/sns/instagram/技術士建設部門/2026-06-10-r08-prediction
 */
