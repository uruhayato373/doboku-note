...
- **UI/SSR 変更**: `curl` で `<main>` + 主要キーワード（土木/技術士）を確認（Lighthouse スコアだけでは SSR 壊れを捕捉できない — [measurement-incidents.md](docs/reference/measurement-incidents.md) 2026-W16 BAILOUT）
