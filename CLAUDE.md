...
| [docs/reference/ig-section-bundles.md](docs/reference/ig-section-bundles.md) | IG カルーセル 51 bundle 集約モデル（旧 660 KW → 51 投稿）・slide-data.json スキーマ・配信ロードマップ・パイプライン書き換え手順 | IG カルーセル投稿準備・bundle 編集・SoT 再生成時 |
