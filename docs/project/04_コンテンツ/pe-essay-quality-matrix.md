...
| r06-essay-environment-survey | 7.3 | 7.3 | 6.5 | 7.9 | 0 | Med | 再評価待ち |
| r07-essay-environment-survey | 7.5 | 8.0 | 7.3 | 7.9 | 0 | Med | 再評価待ち |
...
## 残Med（2本）— 致命的問題なし・スコア8.0未達（7.9）

| slug | 総合 | 残課題 |
|---|---|---|
| r06-essay-environment-survey | 7.9 | Low優先のみ残存（施策間トレードオフ多様性のさらなる向上）|
| r07-essay-environment-survey | 7.9 | Low優先2件残存（設問(3)②の世界情勢記述追加・外国人比率30%の根拠補強）|
...
5. ✅ **残Med 4本の追加リライト＋第2回再評価**（2026-05-20 完了）
   - r03-gc(8.0)・r07-gc(8.0) が公開可到達
   - r06-env(7.9)・r07-env(7.9) がMed残存（致命的0件・Low優先のみ）
6. **公開判断**: published: true への切り替えはユーザー確認後
   - 18本 公開可確定 / r06-env・r07-env は 7.9 で公開判断ライン（8.0）未達
