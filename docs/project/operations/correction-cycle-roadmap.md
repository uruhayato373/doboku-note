...
> **注**: 本 md は Why / 設計思想 / 中止判定の真実源。**残タスク（誰が何をいつ）は Issue #27 が真実源**。ルールは `docs/reference/docs-issue-separation.md` に従う。
...
- R07/R06 の主要 80 問の網羅は、合格者として note 商品・YouTube への展開に必要な深度を優先（週 2 回 × 高優先問題のみ）で進める
