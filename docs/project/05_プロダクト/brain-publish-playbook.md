...
| 販売記事本文 | `docs/project/05_プロダクト/brain-claude-code-essay-skill/02-brain-sales-page-draft.md`（冒頭コピー〜CTA をそのまま貼付） |
| β価格 | 7,980円 |
...
| 販売記事本文 | `docs/project/05_プロダクト/brain-r8-policy-prediction-skill/06-brain-sales-page-draft.md` |
| β価格 | 9,800円 |
