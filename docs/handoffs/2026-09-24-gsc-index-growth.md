...
> 残りのタスクは backlog の DN-0293 / DN-0298 にある。この文書は再開手順と順番だけで、
...
2. ~~note の PDF なし 27 本を再公開~~ 2026-09-24 夜に Mac で済み（太字の記号・重複バナー・`配合計算-実戦演習` の 404 を反映）。張り替えだけの 546 本は 301 等価で再公開不要（check-note-republish の 301 等価判定・PR #604）。PDF 付きほか残りも 2026-09-25 未明に済み（序章 1 本は DN-0271）、旧 URL が正規に選ばれた 17 URL の追跡は **DN-0298**。
