...
4. **建設部門 R8予想 横断商品化**（中）— 既存10科目のR8予想を横断フラッグシップ（総監 r8-essay-forecast 相当）に束ね商品化。欠落2科目（電力土木・鉄道）は `pe-secondary-exam-writer` forecast で補完（小）。受験期7月・最優先seller型ゆえ実は最有力候補
