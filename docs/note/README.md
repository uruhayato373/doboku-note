...
- **横断戦略 SSOT**: `1級・2級土木/noteコンテンツ計画.md` — 伴走メンバーシップ「経験記述ラボ」（1 メンバーシップ・2 層: ベース ¥1,480/月・通年・無制限 ＋ 添削 ¥2,980/月・定員 10・シーズン制）の設計と、級別サブ文書の索引
- **1級 有料マガジン**（公開済）: 施工経験記述-完成答案集（¥2,480/5本）・2テーマ組合せ大全（¥3,480/10本）・過去問模範答案集（¥2,480/5本）
- **2級 有料マガジン**: 施工経験記述-完成答案集（¥1,980/3本・公開済）・過去問模範答案集
