...
- **横断戦略 SSOT**: `1級・2級土木/noteコンテンツ計画.md` — **ライブラリ内包メンバーシップ「土木セコカン合格ラボ」**（2026-07-01 転換）。完成答案・過去問（買い切りマガジン）を会員特典に内包＝会員読み放題＝入会の引き金／FLOW（月例予想＋毎週添削）が引き止め・LTV本体。買い切りは廃止せず¥9,800パックをアンカー化。会員＝通年プラン ¥1,480/月＋添削つきプラン ¥2,980/月・定員 20・シーズン制。設計・級別サブ文書の索引
