...
- **横断戦略 SSOT**: `1級・2級土木/noteコンテンツ計画.md` — **メンバーシップ「土木セコカン 1発合格ラボ」＋買い切り単品の二刀流**。旗艦＝1 メンバーシップ・2 層: ベース ¥1,480/月・通年・無制限（過去問模範解答全アクセス＋会員専用の定期予想）＋ 添削 ¥2,980/月・定員 10・シーズン制。役割分担＝ストックは買い切り＋会員特典の両建て／継続予想・添削は会員専用。設計・級別サブ文書の索引
- **買い切り単品マガジン（販売継続・会員特典にも内包）**: 1級 完成答案集・2テーマ組合せ大全・過去問模範答案集／2級 完成答案集ほか（**二刀流: 買い切り販売を続けつつ会員特典マガジンに紐付け**。制作詳細は各級プラン文書、二刀流設計は計画 §2.3）
