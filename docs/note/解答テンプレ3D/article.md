...
- **3 ペルソナ別模範論文 R03-R07（¥1,480-1,980 × 3）** — 本書第 4 章の業務別論点を実例で確認
...
国土交通白書 R7 完全対応集（**無料公開予定**）。7 大政策テーマ × 5 管理トレードオフ × R08 再出題確率スコア + 過去 9 年連続出題の検証データ + 70 ワークシートを 33,925 字で網羅する予定です。本書のテーマ別テンプレ（第 2 章 20 種）の背景知識として、白書原典の数値（特定技能 18.1 万人 / GX 認定 2023-10 / 予防保全 30 年 3 割縮減 等）を仕入れるのに最適。2026 年 6 月 W3 公開予定で、公開後に本記事末尾へリンクを追記します。
