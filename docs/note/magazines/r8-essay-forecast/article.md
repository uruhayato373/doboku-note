...
- ✅ **3 ペルソナ別アレンジ例**（ゼネコン / 河川コンサル / 道路発注者）
...
| **30 日（1 ヶ月）** | 3 ペルソナ別アレンジを試す | 各章 3-3 / 4-3 / 5-3 節を読む |
...
- [3 ペルソナ別模範論文ハブ](https://doboku-note.com/docs/pe-comprehensive-management-pattern-essay-river-consultant)

#### doboku-note 有料コンテンツ（本書と組合せ推奨）

- **国土交通白書 R7 完全対応集（¥2,480）** — 本書第 1 章の白書連動分析を深掘り
- **解答テンプレ集 3D マトリクス（¥2,980）** — 本書第 2 章テンプレを 20 テーマ × 5 管理 × 3 ペルソナで詳述
- **3 ペルソナ別模範論文 R03-R07（¥1,480-1,980 × 3）** — 本書第 3-5 章のペルソナ別実例
...
- 公開: 2026 年 6 月
- 価格: ¥2,480
- 関連商品: 白書 R7 完全対応集 / 解答テンプレ 3D マトリクス / 3 ペルソナ別模範論文
