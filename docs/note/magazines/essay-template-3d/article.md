...
1. **問題確認 3 分**: 試験問題のテーマを特定（第 2 章 20 テーマ一覧で照合）
2. **ペルソナ確認 2 分**: 自分のペルソナで該当セルを思い出す（第 4 章 4 ペルソナ）
3. **三層構造の骨子 15 分**: 第 5 章の手順で骨子を組み立て
4. **トレードオフ選定 5 分**: 第 6 章 16 ペアから 1-2 ペアを選ぶ
5. **答案執筆 165 分**: 600 字 × 5 枚 = 3,000 字（33 分/枚）
