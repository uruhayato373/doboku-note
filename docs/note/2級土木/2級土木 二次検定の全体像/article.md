...
筆者は元・地方自治体の土木職（発注者）で、1級土木施工管理技士を保有しています。第二次検定は、第一次検定とは性質がまるで違う試験です。一次が知識を広く問う択一中心なのに対し、二次は**書いて答える**試験。ここで戸惑う人が多いので、全体像と対策の順番を整理します。各問題の正確な構成は年度で変わるため、最新の出題はサイトの年度別過去問で確認してください。
