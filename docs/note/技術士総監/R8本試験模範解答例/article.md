...
以下、14の立場それぞれの模範解答を掲載します。各版は「前提条件 → 設問(1) → 設問(2) → 設問(3)」の順で、答案用紙1枚以内の分量で書いています。同じ内容を末尾でPDFとしてもダウンロードできます。
...
## 【無料ダウンロード】立場別 模範解答 PDF（全14ファイル）

本文に掲載した14版の模範解答を、立場別にPDFでも1ファイルずつ添付しています。印刷して手元に置きたい方は、自分の業務に近いものをダウンロードしてください。

- **発注者**（自治体）：01 道路担当／02 河川担当／03 港湾担当／04 砂防担当／05 下水道担当／06 上水道担当／07 公園緑地担当／08 都市計画担当／09 技術基準担当／10 契約調達担当
- **受注者**（民間）：11 ゼネコン／12 河川・砂防コンサル／13 道路・橋梁コンサル／14 都市計画コンサル

ファイルは下に番号順に並んでいます。ファイル名の番号と立場が対応しています。
