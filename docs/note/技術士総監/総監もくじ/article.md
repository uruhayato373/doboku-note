...
---
# 【総監もくじ】技術士 総合技術監理部門の対策コンテンツ総合案内

技術士（総合技術監理部門・総監）の対策コンテンツを、**無料記事から有料教材まで1ページで探せる**もくじです。ブックマーク推奨（更新のたびに追記します）。
...
本番が近い方は、知識を広げるより「いま持っている型を本番で出せる状態に固める」のが最優先です。直前の動き方と総仕上げはこの順でどうぞ。
...
- [令和8年度 R8予想問題集（出る6テーマ）](https://note.com/dobokunote/m/m6854c7437d4d) ← 直前の総仕上げの本命
- [総監記述式 コアパック（型×設問3×R8予想）](https://note.com/dobokunote/m/m6e7de5e4ea3d) ← 書き方の型から固めるなら
- [総監択一 頻出計算問題 6パターン完全攻略](https://note.com/dobokunote/n/ne190c3ef2fca) ← 択一を確実な得点源に

> セット購入の前に1テーマだけ試したい方へ — 上記の有料マガジン（R8予想問題集・設問(3)国家施策バンク・5管理クロストレードオフ）は、各テーマを**¥780で1本から**購入できます。弱点テーマを1本試して手応えがあれば、セットの方が割安です（R8予想問題集なら6本でセット¥3,480＝26%OFF）。
