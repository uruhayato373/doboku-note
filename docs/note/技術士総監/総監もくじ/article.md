...
総監の教材は「書き方の型 → 設問(3)の弾薬 → 本番の演習 → 自分の立場の実例」の順でそろえると最短です。いまの自分に近いものから選んでください。

- **記述式の型から固めたい** → 総監記述式 コアパック（型×設問3×R8予想）
- **迷わず全部そろえたい** → 総監記述式 完全パック（全部入り）
- **本番が近い・直前で仕上げたい** → 令和8年度 R8予想問題集
- **自分の立場に合う模範論文を選びたい** → [総監マガジンの歩き方](https://note.com/dobokunote/n/nc874692256bb)で3分診断
- **まず無料で全体像をつかみたい** → 下の「無料で全体像をつかむ」から

---

## 有料マガジン（記述式の主力）

**総監記述式 コアパック**（型×設問(3)×R8予想）— まず1つ選ぶならこれ。答案の書き方の型、設問(3)で使う国家施策の弾薬、R8で出るテーマの予想までを1つに束ねた記述式の土台です。どのテーマが来ても対応できる骨格が作れます。
...
**令和8年度 R8予想問題集**（出る6テーマ）— 本番が近い人の総仕上げの本命。R8で出題が予想される6テーマについて、設問と模範論文を用意しました。直前期に「型を本番で出せる状態」に固めるのに向いています。
...
本番が近い方は、知識を広げるより「いま持っている型を本番で出せる状態に固める」のが最優先です。直前の動き方はこの順でどうぞ。

- [直前総仕上げロードマップ｜本番1ヶ月前からの逆算チェックリスト（無料）](https://note.com/dobokunote/n/n97e01a94e650) ← 直前にやること/やらないこと
- [令和8年度 総監記述式 R8予想問題（無料版）](https://note.com/dobokunote/n/n8e92e4673a99) ← 予想テーマで実戦演習
- 有料の総仕上げは、上の「有料マガジン」の R8予想問題集・コアパックが本命です。
...
- [【はじめての方へ】R08 合格のための note ロードマップ](https://note.com/dobokunote/n/n3d73729e6cc7) ← 最初の1本
...
- **まず全体像を知りたい** → [R08 合格ロードマップ](https://note.com/dobokunote/n/n3d73729e6cc7)
...
- **R8で出るテーマを押さえたい** → [R8予想問題（無料）](https://note.com/dobokunote/n/n8e92e4673a99) → [R8予想問題集](https://note.com/dobokunote/m/m6854c7437d4d)
