...
技術士総合技術監理部門 令和8年度記述式試験に向けた、自治体都市計画担当ペルソナ視点の予想問題集（資源循環編）です。都市及び地方計画分野の合格者として培った「市街地再開発事業・立地適正化計画・都市ストック」の発注者経験を、R8で出題が予想される資源循環 × 市街地再開発テーマに適用したフル解答2本を収録します。A案は駅前低利用地の面的整備（新設・整備型）における資源循環、B案は既存ストックの長寿命化・用途転換と解体リユースの制度運用（制度運用型）における資源循環という、対称的な管理対象で書き分けています。

**本記事の使い方**: 模範論文はそのまま暗記するのではなく、自分が担当する都市計画業務に置き換えて読むことが前提です。事業名・数値・地域固有の課題は各自の業務実態に差し替えたうえで、答案構成の骨格として活用してください。駅前再開発などの新設プロジェクト経験が中心ならA案、既存ストックの活用・リノベーション誘導や解体リユースの制度運用の経験が中心ならB案を本番選択の基準にしてください。
