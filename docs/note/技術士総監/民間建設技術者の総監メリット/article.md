...
この記事は、建設コンサルタントや建設会社に勤める民間技術者の視点から、総監を取ることの金銭的な価値を3つのレイヤーに分解して検証します。私は総監に合格していますが、この記事では「合格したから良かった」という体験論ではなく、受験を決める前に私自身が集めた「数値としての根拠」を、出典を明示しながらまとめます。
...
この記事は、私が総監の受験を決める前に集めたデータをもとにしています。合格した今も、まず「体験談」より「数値の根拠」を示す姿勢は変えていません。
