...
- 本書 ¥980 + 総監の合否を分ける「トレードオフ思考」完全ガイド ¥1,200 + 総監記述式 論文骨子テンプレート（A-1）¥1,980 — テーマ駆動・5 管理横串フレームワーク = 単品合計 ¥4,160
- セット価格 **¥3,480**（16% OFF）

**著者プロフィール**
土木技術者として 1 級土木施工管理技士・建設部門の技術士に合格後、総合技術監理部門にも合格。学習過程で蓄積した 700 キーワードの解説と 17 年分の過去問分析を doboku-note にて無料公開しています。
