...
年度別のマクロテーマと6テーマ系統の関係は、<https://doboku-note.com/docs/pe-construction-required-exam-themes> で一覧できます。
...
改訂の詳細は <https://doboku-note.com/docs/pe-construction-competency-revision-r8> にまとめています。

論点の引き出しを増やすには、年度別の出題傾向と、隣接する6テーマとの接続を押さえておくことが近道です。

答案そのものの組み立て方は <https://doboku-note.com/docs/pe-construction-pe-secondary-essay-guide> も参考にしてください。
