...
本記事は技術士第二次試験 建設部門 令和5年度 選択科目III（河川・砂防及び海岸・海洋）のIII-1・III-2の両問題について、元自治体土木職として河川・砂防・海岸工事の発注・監督に携わった発注者視点の模範解答を提示します。選択科目IIIは課題遂行能力を問う科目で、答案用紙3枚（約1,800字以内）を使って課題抽出・解決策・残余リスク対策の3段構成で論述します。本番では2問題のうち1問を選んで解答しますが、本記事では出題された両問題を網羅し、どちらを選んでも対応できるようにしています。
