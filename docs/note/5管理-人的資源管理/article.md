...
人的資源管理は、5管理の中で **出題の幅が最も広い分野** です（テキスト第2章は59項目）。動機づけ理論・組織論・労働法・人事制度・人材開発まで、心理学・法律・経営学を横断する知識が問われます。
...
全項目を均等に勉強するのは非効率です。**「動機づけ理論3本柱／リーダーシップ／労働基準法／人事考課」を最優先** （PM・SL・サーバント、時間・年休・三六協定、3指標・6バイアスの順で深掘り）とし、残りはリンク先で確認するのが効率的です。本記事では、テキスト第2章の骨格を活かしながら、択一・記述式の出題視点でポイントを絞り直します。

## 人の行動と組織（優先度: 最高）

テキスト第2章の冒頭に位置するこのエリアは、**択一式で最も出題頻度が高い領域** です。動機づけ理論3本柱とリーダーシップ論は毎年いずれかが出題されていると考えてよく、最優先で押さえる必要があります。
