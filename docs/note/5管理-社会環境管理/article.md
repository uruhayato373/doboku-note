...
社会環境管理は、5管理の中で **国際条約・環境法規・制度の数が最も多い分野** です。テキスト第5章は地球的規模の環境問題・地域環境問題・環境保全の基本原則・組織の社会的責任の4大エリアをカバーし、サブトピックは30以上に及びます。
...
全エリアを均等に勉強するのは非効率です。**「環境基本法と7原則」「国際条約4種」「環境アセスメント」「LCA」「ESG投資・TCFD」を最優先** とし、残りはリンク先で確認するのが効率的です。本記事では、テキスト第5章の骨格を活かしながら、択一・記述式の出題視点でポイントを絞り直します。
