...
- **付属の印刷用PDF（A5・赤シート対応）を現場ポケットに入れて回す**：note公開時に、この一問一答を赤シートで隠せるA5サイズの印刷用PDFを添付する予定です（本文の一問一答リストと同内容）。印刷して現場の作業服のポケットに入れ、昼休みや移動中に回すと、机に向かう時間が取れない受験者でも直前期に何周も回せます。
