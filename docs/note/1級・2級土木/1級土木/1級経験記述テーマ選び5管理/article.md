...
筆者は元・地方自治体の土木職（発注者）で、1級土木施工管理技士を保有しています。1級は2級と違い、品質・安全・工程に加えて**施工計画・環境対策**を含む5管理が対象です。題材選び——「どの工事を、どの管理項目で書くか」——で答案の出来は半分決まります。出題形式の基本はサイトの無料解説に譲り、ここでは題材選びに絞ります。
