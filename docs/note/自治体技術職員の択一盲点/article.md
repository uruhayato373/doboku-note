...
この記事では、自治体の技術職員が特につまずきやすい3つの盲点を整理します。5管理を出題視点で優先度順に整理し直した精読ガイドもあるので、手薄な分野を効率的に埋めたい方は末尾の案内もご覧ください。
...
![発注者の実務感覚と択一出題範囲のズレ。択一は5管理に8問ずつ均等配分だが、発注者の実務との距離は分野ごとにムラがあり、経済性管理の手法系・人的資源管理・安全管理が盲点になる](img/figure-1-coverage-gap.png)
