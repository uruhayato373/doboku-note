...
本記事の対策で挙げた「キーワード集の3周読み」「5管理トレードオフマトリクスの活用」を、ゼロベースで自作する負担を最小化するために設計したのが、5管理ごとの精読ガイド5本セットです。各キーワードから doboku-note 解説ページに即遷移できるため、通勤時間にスマホで5管理を俯瞰できます。単品合計 ¥4,900 → セット ¥3,980（19%OFF）。
