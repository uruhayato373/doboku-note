...
| フォント | Noto Sans JP Bold。**ダーク主題は最大 88px**（`MAIN_FONT_TABLE`・縦フィットで自動縮小）/ kicker 34px / サブ＝主題 ×0.46（最小 26px）。ライトはタイトル最大 76px |
| 主要要素（ダーク） | **資格名 kicker（accentLight）** / **コンテンツ種別バッジ（右上・accentLight 輪郭ピル）** / **主題（白・大）** / **サブタイトル（淡色・小）** / 左下ドメイン `doboku-note.com` |
| 装飾要素 | グリッド全面（30px fine + 120px major・ダークは白系微光）/ 左上シアンバー（80×4）/ accentLight 16px 外枠 |
