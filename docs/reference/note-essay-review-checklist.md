...
| 自治体（公開済・R08旧式） | 道路 | ⚠️ note 公開済（published:true）かつ R03-R07 構造ベンチマークだが、**R08 が旧単一 `R08-yosou`**（`check-essay-heading-structure` で違反検出）＋ 旧 `_meta.yaml` 残存。新標準へ揃えるには R08 2記事化＋note再投稿が必要（公開済のためコスト判断） |
