...
| 区分 | ペルソナ | 状態 |
|---|---|---|
| 自治体（発注者・真正） | 河川 / 都市計画 / 下水道 / 上水道 / 港湾 | ✅ 公開品質化＋note掲載文.txt化済（_meta.yaml 廃止） |
| 自治体（未着手） | 道路 / 砂防 / 公園緑地 / 建築営繕 / 農業農村 / 技術基準 / 契約調達 / アセットマネジメント | 🟡 旧 `_meta.yaml` 残存。公開品質化の際に Step 6f で `.txt` 化 |
