...
| `civil-keiken-essay-qa`        | 1級・2級土木 施工経験記述 マガジン模範答案の5軸採点（重複回避/形式適合/捏造なし/著作権・改変前提/採点視点）＋必須ゲート（U+FFFD・本文価格/ID〔導線リンクカードURLは許可〕・サイト重複・問題文整合・字数 strict）＋ハッシュタグ節は推奨検査              | Evaluator    | sonnet  | civil-keiken-magazine 連携、civil-keiken-essay-writer と対                | ✅ 運用中（2026-05-29 起動）                      |
