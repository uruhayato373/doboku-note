...
### 【完了 2026-06-20】2級土木 ガイド記事の充実・SEO 強化

**結論**: 増量リライト済みと現物確認（2026-06-20）。2級 guide 全14本は **3,988〜6,831 字**（最小 guide-overview 3,988字／最大 guide-exam-overview 6,831字）で、当初の「137〜262語」状態は既に解消。本項目はクローズ。残課題があるとすれば seoTitle/description の検索意図最適化・内部リンク強化だが、字数目標（3,000字超）は全本達成済み。
