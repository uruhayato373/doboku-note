...
この「総合的な判断・調整」こそがトレードオフの処理にほかなりません。5つの管理すべてを100%満たすことは現実には不可能であり、限られた資源の中でどの管理を優先し、どこで妥協するかを判断する --- それが総監技術士の仕事です。
...
5つの管理のあらゆる組み合わせ --- 全10通り --- でトレードオフが発生しえます。以下は、各管理間で生じる典型的な対立構造の全体像です。
...
このマトリクスの詳細な解説は、doboku-noteの「[合格戦略 --- トレードオフ思考と学習計画](https://doboku-note.com/docs/pe-comprehensive-management-exam-passing-strategy)」で確認できます。
...
過去問を使った実践的な対策は、doboku-noteの「[択一式・記述式 過去問一覧](https://doboku-note.com/docs/pe-comprehensive-management-exam-index)」から取り組めます。17年分の過去問を解きながら、トレードオフ思考を鍛えてみてください。
