...
分野別の出題傾向については、doboku-noteの[択一式17年分分析](https://doboku-note.com/docs/pe-comprehensive-management-exam-passing-strategy)で詳しく解説しています。毎年出る鉄板テーマ10選を押さえるだけでも、10問以上を安定して確保できます。
...
この「トレードオフ思考」の具体像は、doboku-noteの[合格戦略ページ](https://doboku-note.com/docs/pe-comprehensive-management-exam-passing-strategy)で5管理間トレードオフのマトリクスとともに解説しています。
...
- 記述式で B/C 判定だった → 総監記述式 論文骨子テンプレート ¥1,980 / トレードオフ思考完全ガイド ¥1,200
