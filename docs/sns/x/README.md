...
- `#技術士` (7 weight): 大規模・発見性高
- `#技術士総監` (11 weight): 専門度シグナル、指名検索の核
...
- ❌ `#技術士` 1 個だけ（ベース 2 個必須: `#技術士 #技術士総監` が最低ライン）
...
- ✅ ハッシュタグは **ベース 2 個（`#技術士 #技術士総監`）+ 種別 1-2 個 = 計 3-4 個**
- ✅ URL は **1 本のみ**、utm 必須
- ✅ 改行は **1 行空け**（連続改行は字数浪費）
