...
```
1. 7 枚 PNG 確認
   node .claude/scripts/instagram/build-highlight-materials.mjs --dir docs/sns/instagram/highlights/02_carousel-index
       ↓
...
| カルーセル投稿の SoT | `docs/sns/instagram/_exam-packs/<year>/pack-NN/`（過去問パック）/ ig-carousel-writer 経由のキーワードパック |
