...
1. 6 枚 PNG が img/ に生成済みであることを確認
   node .claude/scripts/instagram/build-highlight-materials.mjs --dir docs/sns/instagram/highlights/01_intro
       ↓
...
| 対応資格・コンテンツ統計 | `docs/project/01_戦略/01_プロダクト戦略.md` |
...
`docs/project/03_SNS/02_チャネル動線設計.md` §4 と整合。
