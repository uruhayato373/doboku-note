...
1. slide-data.json を編集
   ...
   - 03-cta の chipCta を着地点キーに変更（任意）
       ↓
2. PNG 再生成
   node .claude/scripts/instagram/build-highlight-materials.mjs --dir docs/sns/instagram/highlights/05_announcement
       ↓
3. Stories 3 枚を順番に連投
...
| 受験スケジュール | `docs/project/03_SNS/02_チャネル動線設計.md` §6 季節 × チャネルマトリクス |
