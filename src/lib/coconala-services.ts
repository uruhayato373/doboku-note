...
const SERVICES_RAW = {
  ...
  'coconala-2kyu-sakusei': {
    ...
    description:
      '2級土木施工管理技士 第2次検定の施工経験記述（問題1）を、ご自身で書けるように指導するサービス。ヒアリングで実工事の事実を整理して2テーマ分の骨子シート（何を・どの順で・どの数値で書くか）を48時間以内にお渡しし、骨子をもとにご本人が書いた答案を添削、書き直し後の再添削1回まで行います。答案の代筆はしません。経験していない工事や数値の創作もお受けしません。合格を保証するものではありません。',
