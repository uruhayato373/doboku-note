...
const SERVICES_RAW = {
  ...
  'coconala-tensaku-4theme': {
    ...
    description:
      '1級土木施工管理技士 第2次検定の施工経験記述（問題1）を、5テーマ（品質管理・安全管理・工程管理・施工計画・環境対策）すべて添削。当日どの2テーマが指定されても自分の工事で書けるよう、全5テーマ分の赤入れ（NG→OK 書き換え案）＋6観点のチェックリスト判定表＋読み手視点のコメント＋書き直し1回（まとめて）を、受け取りから48時間以内にお返しします。経験していない工事や数値の創作はお受けしません。',
  ...
  'coconala-sakusei-4theme': {
    ...
    title: '1級土木経験記述の全5テーマを骨子から指導します',
    shortTitle: '1級 経験記述 指導（全5テーマ）',
    description:
      '1級土木施工管理技士 第2次検定の施工経験記述（問題1）を、ご自身で書けるように指導するサービス。ヒアリングで実工事の事実を整理して全5テーマ（品質管理・安全管理・工程管理・施工計画・環境対策）分の骨子シート（何を・どの順で・どの数値で書くか）を72時間以内にお渡しし、骨子をもとにご本人が書いた答案を添削、書き直し後の再添削1回まで行います。下書きがすでにある方は添削サービスへ。答案の代筆はしません。経験していない工事や数値の創作もお受けしません。合格を保証するものではありません。',
