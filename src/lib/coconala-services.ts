...
const SERVICES_RAW = {
  ...
  //   より旗艦1本に集約。単品計 ¥14,000 → ¥9,800（30%off）。note 旗艦「完全攻略パック」
  //   （¥9,800・経験記述の深さ＝組合せ大全/想定工事索引）とは軸が直交（こちらは二次全体の広さ）
  //   で同額＝undercut しない。納品は既存 C系 PDF をそのまま送付（新規ビルドなし・労働ゼロ）。
  'coconala-1kyu-full-pdf': {
    ...
    description:
      '1級土木施工管理技士 第2次検定の対策PDFを全部入りでまとめたフルパック（計18冊）。出題分析＋直前重点（1冊）・経験記述 完成答案集（5冊・5管理）・経験記述 過去問模範答案（5冊・R03-R07）・学科記述 攻略（5冊・5論点）・予想模擬試験（問題冊子＋解答解説の2冊）を一括でお送りします。単品を買い分ける必要がなく、分析→インプット→演習→模試まで一気通貫。購入後トークルームで PDF をお送りします（本試験の出題を保証するものではありません）。',
    price: '¥9,800（PDF 18冊・単品計¥14,000）',
    priceYen: 9800,
    examScope: ['civil-1'],
    weeklyCapacity: 20,
  },
  ...
  'coconala-2kyu-full-pdf': {
    ...
    description:
      '2級土木施工管理技士 第2次検定の対策PDFを全部入りでまとめたフルパック（計15冊）。経験記述 完成答案集（3冊・3管理）・経験記述 過去問模範答案（5冊・R03-R07）・学科記述 攻略（5冊・5論点）・予想模擬試験（問題冊子＋解答解説の2冊）を一括でお送りします。単品を買い分ける必要がなく、インプット→演習→模試まで一気通貫。購入後トークルームで PDF をお送りします（本試験の出題を保証するものではありません）。',
    price: '¥6,980（PDF 15冊・単品計¥10,500）',
    priceYen: 6980,
    examScope: ['civil-2'],
    weeklyCapacity: 20,
  },
