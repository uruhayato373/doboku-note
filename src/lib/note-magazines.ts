...
const MAGAZINES_RAW = {
  ...
  'essay-road-paving-contractor-magazine': {
    ...
    shortDescription: 'R03〜R07、各年A・Bの2案。施工計画・合材製造・路上施工・交通規制を5管理で論じる答案モデル。',
    price: '¥1,980（5記事・各年2答案）',
    badge: 'note 実務立場別 教材',
  },
  ...
  'civil-1-keiken-bridge-maintenance-pack': {
    ...
    shortDescription: '橋梁補修・更新の8工事×5管理。完全攻略パック収録済み記事の分野別セット。',
    price: '¥3,980（8工事セット）',
    badge: 'note 分野別教材',
  },
  ...
  'civil-1-keiken-water-treatment-pack': {
    ...
    shortDescription: '供用継続を伴う上下水道・処理施設7工事×5管理。完全攻略パック収録済み記事を再編集。',
    price: '¥3,980（7工事セット）',
    badge: 'note 分野別教材',
  },
  ...
  // 実務立場別32答案をテーマごとに横断再編集。既存の全32答案集・立場別パックとの重複を明記する。
  ...
  'cce-theme-durability-pack': {
    id: 'cce-theme-durability-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/m8c199a48d1c9',
    title: '主任技士 小論文｜耐久性 8つの実務立場',
    description: 'コンクリート主任技士の小論文「耐久性」を、生コン・プレキャスト・土木施工・維持管理・発注者・建築施工・設計・試験検査の8立場で比較する答案集。有料8記事と無料の立場選択ガイドを収録。実務立場別全32答案集・各立場別4テーマ・まるごとパックと同じ記事のため、購入者は追加購入不要。',
    shortTitle: '主任技士 耐久性 8立場',
    shortDescription: '耐久性確保を8つの実務立場で横断比較。自分の責任範囲に合う論述を選ぶ。',
    price: '¥2,980（有料8記事＋無料ガイド）',
    badge: 'note テーマ別教材',
  },
  'cce-theme-environment-pack': {
    id: 'cce-theme-environment-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/m87990d073b2f',
    title: '主任技士 小論文｜環境配慮 8つの実務立場',
    description: 'コンクリート主任技士の小論文「環境配慮」を、生コン・プレキャスト・土木施工・維持管理・発注者・建築施工・設計・試験検査の8立場で比較する答案集。有料8記事と無料の立場選択ガイドを収録。実務立場別全32答案集・各立場別4テーマ・まるごとパックと同じ記事のため、購入者は追加購入不要。',
    shortTitle: '主任技士 環境配慮 8立場',
    shortDescription: '環境負荷低減を8つの実務立場で横断比較。各段階の権限と管理指標を整理。',
    price: '¥2,980（有料8記事＋無料ガイド）',
    badge: 'note テーマ別教材',
  },
  'cce-theme-trouble-pack': {
    ...
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/m01a4cf69b414',
    title: '主任技士 小論文｜施工トラブル 8つの実務立場',
    description: 'コンクリート主任技士の小論文「施工トラブル」を、生コン・プレキャスト・土木施工・維持管理・発注者・建築施工・設計・試験検査の8立場で比較する答案集。有料8記事と無料の立場選択ガイドを収録。実務立場別全32答案集・各立場別4テーマ・まるごとパックと同じ記事のため、購入者は追加購入不要。',
    shortTitle: '主任技士 施工トラブル 8立場',
    shortDescription: '初動・原因究明・是正・再発防止を8つの実務立場で横断比較。',
    price: '¥2,980（有料8記事＋無料ガイド）',
    badge: 'note テーマ別教材',
  },
  ...
  // を API 実体確認。2026-09-17 に暗記ノート、9/19 に問題Iの3部門記入例を加え全13記事。
  'rccm-marugoto-pack': {
