...
const MAGAZINES_RAW = {
  ...
  'essay-road-municipality-magazine': {
    ...
    published: false,
    noteUrl: '',
    title: '総監記述式 模範論文｜自治体 道路担当 R5-R7 + R8予想セット',
    description:
      'R05/R06/R07 の3年分過去問対策 + R08 予想問題集（気候変動適応・資源循環）。R7/R6 は橋梁長寿命化版とバイパス整備版の 2 バージョン併記、R5 は道路維持管理組織版、R8 予想は自治体 道路担当フル解答 2 本の合計 7 本フル論文。地方自治体の道路担当（発注者）の立場で「経済性 × 安全 × 社会環境」を主軸に組み立てる論文構成を解説。試験 1 ヶ月前（2026-06）に R8 予想章を追加公開予定。',
    shortTitle: '模範論文｜自治体 道路担当 R5-R7+R8予想',
    shortDescription:
