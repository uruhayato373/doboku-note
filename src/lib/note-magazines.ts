...
const MAGAZINES_RAW = {
  ...
  'essay-river-consultant-magazine': {
    ...
    title: '総監記述式 模範論文｜建設コンサル河川・砂防 R3-R7＋R8予想（4テーマ）',
    description:
      'R03〜R07 過去問（治水計画の調査計画版/河川管理施設の点検・補修更新設計版の A案/B案 2 バージョン）＋ R8予想4記事（老朽化インフラ・災害復旧・AI社会・経済安全保障、各 A案/B案）の計 9 記事。中堅建設コンサル河川・砂防部門 部長（調査設計者）視点、5管理トレードオフが主軸。テーマ横断の「R8予想問題集」も別途展開。',
  ...
  'essay-general-contractor-magazine': {
    ...
    title: '総監記述式 模範論文｜ゼネコン R3-R7＋R8予想（4テーマ）',
    description:
      'R03〜R07 過去問（新設・改良施工版/維持・更新・補修施工版の A案/B案 2 バージョン）＋ R8予想4記事（老朽化インフラ・災害復旧・AI社会・経済安全保障、各 A案/B案）の計 9 記事。中堅〜大手ゼネコン土木部門（施工者）視点、安全 × 経済性 × 人的資源 のトレードオフが主軸。テーマ横断の「R8予想問題集」も別途展開。',
  ...
  'cce-essay-magazine': {
    ...
    description:
      'コンクリート主任技士試験の小論文対策フル模範答案集。択一とは評価軸が異なる小論文（実務経験を技術論述に変換する試験）を、答案の型と4観点で攻略する。解法ガイド1本＋テーマ別フル模範小論文4本（耐久性・品質管理・環境配慮・施工トラブル）。各テーマは想定問題＋答案の方針＋1200〜1700字級フル模範小論文（固有数値は置換前提）＋採点者視点＋置換ガイドで構成。実在過去問の逐語再現はしない。',
