...
const MAGAZINES_RAW = {
  ...
  // を API 実体確認。単品合計 ¥6,940 → ¥5,980（約14%OFF）。直前暗記ノート（P2-c）公開後に追加収録する。
  'rccm-marugoto-pack': {
    id: 'rccm-marugoto-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/me2b526bf77f4',
    title: 'RCCM まるごとパック（問題I〜IV 全対応・模範論文集＋業務経験論文テンプレ＋択一予想50問）',
    description:
      'RCCM資格試験の試験A（問題I 業務経験論文・問題II 択一）と試験B（問題III 管理技術力・問題IV 択一）、4問全部の教材を1つに束ねたパック。2026年度 公開6テーマの模範論文集（序章無料）、業務経験論文の2,400字テンプレと3部門の記入例、択一の出題範囲マップ＋予想50問を収録。過去問は事務局非公開のため全て自作。単品合計¥6,940が¥5,980。',
    shortTitle: 'RCCM まるごとパック',
    shortDescription: '問題I〜IV 全対応。模範論文集＋業務経験論文テンプレ＋択一予想50問、単品合計¥6,940が¥5,980。',
    price: '¥5,980（問題I〜IV 全対応・単品合計¥6,940、約14%OFF）',
