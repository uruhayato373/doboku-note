...
const MAGAZINES_RAW = {
  ...
  'civil-1-gakka-kijutsu': {
    ...
    description:
      '1級土木施工管理技士 第2次検定の学科記述（問題2〜11）を、年度別ではなくテーマ別に横断再編した完全攻略集。土工／コンクリート／品質管理／安全管理／施工計画・環境／法規・穴埋め頻出語句／書き方の型の7本立てで、令和3〜7年度の5年分の出題を分野ごとに束ね、出題頻度マトリクス（何が何年に出たか）と出る順ランキング、設問パターン別の解答の型、頻出語句の穴埋めリストを収録。過去問の客観的な頻度分析に基づく後ろ向きの整理で、経験記述（問題1）で埋まっていた対策の穴を学科記述側から埋める。※改変・自作の学習前提。合格を保証するものではありません。',
    shortTitle: '1級土木 二次学科記述 テーマ別出る順',
    shortDescription:
      '問題2〜11をテーマ別に横断再編。5年分の出題頻度＋出る順＋解答の型＋頻出語句。7本セット。',
  ...
  'civil-2-gakka-kijutsu': {
    ...
    published: false,
    noteUrl: '',
    title: '2級土木 二次学科記述｜テーマ別 出る順 完全攻略（問題2〜11）',
    description:
      '2級土木施工管理技士 第2次検定の学科記述（問題2〜11）を、年度別ではなくテーマ別に横断再編した完全攻略集。土工／コンクリート／品質管理／安全管理／施工計画・環境の5本立てで、令和3〜7年度の出題を分野ごとに束ね、出題頻度と出る順、設問パターン別の解答の型、頻出語句の穴埋めリストを収録。過去問の客観的な頻度分析に基づく後ろ向きの整理。※改変・自作の学習前提。合格を保証するものではありません。',
    shortTitle: '2級土木 二次学科記述 テーマ別出る順',
    shortDescription:
      '問題2〜11をテーマ別に横断再編。出題頻度＋出る順＋解答の型＋頻出語句。5本セット。',
  ...
  'civil-2-anki-note': {
    ...
    description:
      '2級土木施工管理技士 第2次検定の学科記述（問題2〜11）で問われる穴埋め頻出語句を、分野別に一問一答へ整理した直前暗記ノート。令和3〜7年度の出題語句から頻出のものを抽出し、一問一答＋赤シート対応の印刷用PDF（A5・現場ポケット携行）を添付。試験直前の総仕上げに特化した最小構成・低価格のエントリー商品。※合格を保証するものではありません。',
