...
const MAGAZINES_RAW = {
  ...
  'essay-complete-pack': {
    ...
    description:
      '技術士総監 記述式（必須科目Ⅰ）対策の全部入り。クロストレードオフ（5管理対立の型）＋設問3国家施策バンク（弾薬）＋R8予想問題集（演習）＋模範論文 全14ペルソナ（受注者4＋自治体10・フル実演）＋5管理テキスト精読ガイドを1パックに収録。自分の専門分野が必ず入る網羅保証。単品合計¥44,640相当。',
  ...
  // 原稿配置: docs/note/1級・2級土木/2級土木/magazines/2級土木-想定工事バンク/
  ...
  'civil-2-koji-bank': {
    ...
    description:
      '2級土木施工管理技士 第2次検定 問題1（施工経験記述）の想定工事バンク。8工種グループ36工事を収録し、自分が経験した工事に近い工種を選べば、その1工事で品質・安全・工程の3管理をまとめて準備できる工種起点の完成答案集。各工種で現行形式（令和6年度〜・各250字）と令和5年度以前の3項目形式の両方に対応したフル答案＋自分の現場への置換ガイド＋減点NG→合格答案の添削例＋採点者視点＋2テーマ必答の組合せ早見表を収録。必出の3管理に加え、制度改定に備えた保険として施工計画・環境対策も同じ工事で用意（この2つは現状の経験記述では未出題）。無料の工事起点索引で自分の現場に近い工事を探せる。現場代理人レベルの独自表現で、改変前提のテンプレート（合格を保証するものではありません）。',
  ...
  // 設計: docs/note/1級・2級土木/1級土木/1級土木-想定工事バンク設計.md
  // マガジン枠は note 公開済(noteUrl 取得済 2026-06-30)。ただし 100 工事の収録は順次進行中のため、
  ...
  // ===== 二次 学科記述（問題2〜9）買い切りライン (2026-07-03 設計登録) =====
  // 既存 civil 買い切りは全て問題1（施工経験記述）。二次配点の約4割を占める学科記述（問題2〜9）と
  // 低価格エントリー帯が完全空白だったため新設（noteコンテンツ計画.md §9）。
  // Red Line 整合: サイト secondary-* 無料は「年度別・R03-R07・全問解説」。本ラインは
  //   「テーマ縦断・H30-R07 8年・出題頻度データ・暗記特化」＝加工付加価値で非重複（Red Line #4/#7）。
  ...
  // P1: 1級 二次学科記述 テーマ別 出る順（7本セット・単品¥580）
  'civil-1-gakka-kijutsu': {
    id: 'civil-1-gakka-kijutsu',
    published: false,
    noteUrl: '',
    title: '1級土木 二次学科記述｜テーマ別 出る順 完全攻略（問題2〜9）',
    description:
      '1級土木施工管理技士 第2次検定の学科記述（問題2〜9）を、年度別ではなくテーマ別に横断再編した完全攻略集。土工／コンクリート／品質管理／安全管理／施工計画・環境／法規・穴埋め頻出語句／書き方の型の7本立てで、平成30〜令和7年度の8年分の出題を分野ごとに束ね、出題頻度マトリクス（何が何年に出たか）と出る順ランキング、設問パターン別の解答の型、頻出語句の穴埋めリストを収録。過去問の客観的な頻度分析に基づく後ろ向きの整理で、経験記述（問題1）で埋まっていた対策の穴を学科記述側から埋める。※改変・自作の学習前提。合格を保証するものではありません。',
    shortTitle: '1級土木 二次学科記述 テーマ別出る順',
    shortDescription:
      '問題2〜9をテーマ別に横断再編。8年分の出題頻度＋出る順＋解答の型＋頻出語句。7本セット。',
  ...
  'civil-2-gakka-kijutsu': {
    ...
    description:
      '2級土木施工管理技士 第2次検定の学科記述（問題2〜9）を、年度別ではなくテーマ別に横断再編した完全攻略集。土工／コンクリート／品質管理／安全管理／施工計画・環境の5本立てで、令和3〜7年度＋過去問集の出題を分野ごとに束ね、出題頻度と出る順、設問パターン別の解答の型、頻出語句の穴埋めリストを収録。過去問の客観的な頻度分析に基づく後ろ向きの整理。※改変・自作の学習前提。合格を保証するものではありません。',
  ...
  'civil-1-anki-note': {
    ...
    description:
      '1級土木施工管理技士 第2次検定の学科記述（問題2〜9）で問われる穴埋め頻出語句を、分野別に一問一答へ整理した直前暗記ノート。平成30〜令和7年度の出題語句から頻出のものを抽出し、150〜250問の一問一答＋赤シート対応の印刷用PDF（A5・現場ポケット携行）を添付。試験直前の総仕上げ・スキマ時間の詰め込みに特化した最小構成のエントリー商品。※合格を保証するものではありません。',
  ...
  'civil-1-niji-marugoto-pack': {
    ...
    description:
      '1級土木施工管理技士 第2次検定を、経験記述（問題1）と学科記述（問題2〜9）の両面からまるごと対策する最上位パック。施工経験記述 完全攻略パック（想定工事×5管理の全模範答案）と、二次学科記述 テーマ別出る順（8年分の頻度分析＋解答の型）、直前暗記ノート（穴埋め頻出語句 一問一答）を1つに統合。単品合計より割安に束ねた買い切りアンカー。個別添削や月例予想での伴走が欲しい方は、メンバーシップ「土木セコカン合格ラボ」が別途あります。※改変前提のテンプレートで、合格を保証するものではありません。',
