...
const MAGAZINES_RAW = {
  ...
  // クロストレードオフ + 設問3バンク + R8予想 + 模範論文14ペルソナ（全立場×分野）のバンドル。
  // 恒常¥7,980 / 試験直前限定¥5,980（試験後に¥7,980へ戻す）。実装前提は noteコンテンツ計画.md M13 参照。
  // 単品合計¥42,660相当 = ①¥1,980 + ②¥2,480 + ③¥3,480 + 模範論文14ペルソナ×¥2,480。
  // ⚠ 公開ゲート(2026-06-15確定): note 上の完全パックは現在5ペルソナのみ収録。残9ペルソナ
  //    （道路橋梁コンサル/都市計画コンサル/自治体: 河川/都市計画/港湾/砂防/公園緑地/技術基準/契約調達）
  //    を note pack へ追加収録するまで、この description で site deploy / ロードマップ note 再公開をしない。
  'essay-complete-pack': {
    ...
    description:
      '記述式の答案完成パイプラインを1パックで完結。クロストレードオフ（5管理対立の型）＋設問3国家施策バンク（設問3の弾薬）＋R8予想問題集（予想演習）＋模範論文14ペルソナ（フル実演・全立場×分野）を収録。単品合計¥42,660相当。',
