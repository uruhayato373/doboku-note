...
const MAGAZINES_RAW = {
  ...
  'essay-road-municipality-magazine': {
    ...
    description:
      'R05/R06/R07 の3年分。R7/R6 は橋梁長寿命化版とバイパス整備版の 2 バージョン併記、R5 は道路維持管理組織版の合計 5 本フル論文。地方自治体道路発注者の立場で「経済性 × 安全 × 社会環境」を主軸に組み立てる論文構成を解説。',
    shortTitle: '模範論文｜道路発注者',
    shortDescription:
      'R05〜R07 の 3 年分セット。R7/R6 は2パターン併記の計5本。地方自治体道路発注者視点。',
    imageUrl: '/images/magazines/essay-road-municipality-cover.webp',
    price: '¥1,800（単品 3本 ¥1,500 → 5本分の情報量で実質40%OFF）',
    badge: 'note 限定',
  },
