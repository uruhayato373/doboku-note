...
const MAGAZINES_RAW = {
  ...
  // ----- 総監 全記事パック 2026年版 (2026-06-09 作り変え) -----
  // 【リローンチ準備中】旧「記述式 完全パック」（6本/¥7,980、m171222175fac、2026-06-03公開）を
  // 「全記事パック 2026年版」（全21本/¥14,800、単品合計¥50,080 → 約70%OFF）へ作り変え予定。
  // 主訴求: 令和8年から受験料 ¥20,500（32年ぶり値上げ）→「再受験1回より安く合格教材が揃う」。
  // ゲート: 未公開15マガジン（精読ガイド＋模範論文14ペルソナ）の note 公開完了。原稿は全件完成済。
  // 公開完了まで本エントリは現行 ¥7,980/6本（m171222175fac）を据え置く（存在しない価格を広告しない）。
  // リローンチ時に price/title/description/imageUrl を ¥14,800・全記事パック仕様へ更新。
  // 設計仕様: docs/note/技術士総監/magazines/総監記述式-完全パック/_meta.yaml ＋ noteコンテンツ計画.md M13。
  'essay-complete-pack': {
