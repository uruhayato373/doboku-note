...
const MAGAZINES_RAW = {
  ...
  'essay-complete-pack': {
    ...
    title: '総監記述式 完全パック｜型×設問3×予想×全17ペルソナ模範論文＋精読＋択一PDF 全部入り',
    description:
      '型・国家施策・R8予想演習・17ペルソナの模範論文（受注者7＋自治体10）・精読・択一過去問PDFを収録した全202記事。土質基礎コンサル・上下水道コンサル・維持更新施工の3ペルソナは令和3〜7年度を各年A・B案で収録。既存14ペルソナとは収録年度が異なります。口頭試験対策は別売です。',
    shortTitle: '記述式 完全パック',
    shortDescription:
      '型×設問3×予想×全17ペルソナ模範論文＋精読＋択一PDFの全部入り。総監対策の決定版バンドル。',
    price: '¥9,800',
    badge: 'note 限定',
  ...
  'rccm-marugoto-pack': {
    ...
    title: 'RCCM まるごとパック｜問題I・II・III・IV-1の全13記事',
    description:
      '問題IIIの公開6テーマの模範論文、問題Iのテンプレートと6部門の記入例、問題II・IV-1の予想50問・直前暗記ノートを収録。全13記事。問題IV-2の部門別専門技術知識は含みません。記入例は架空の業務による学習用モデル。2,400字は練習用の目安です。',
    shortTitle: 'RCCM まるごとパック',
    shortDescription: '問題IIIの6テーマ、問題Iの6部門記入例、問題II・IV-1の予想・暗記を全13記事に。IV-2は対象外。',
    price: '¥5,980',
