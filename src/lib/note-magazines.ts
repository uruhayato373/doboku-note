...
const MAGAZINES_RAW = {
  ...
  'pe-construction-required-magazine': {
    ...
    description:
      '技術士第二次試験 建設部門で全受験者必須の「必須科目I」を、令和3〜7年度の5年分まとめた模範解答集。元・地方自治体の土木職（発注者）視点で、安全・品質・コスト・環境の統合判断や住民対応・行政責任といった採点軸を補う。各年度に設問全文（出典明記）を再掲し、設問構成と論述方針・約1,500〜1,650字のフル模範解答・採点者が見るポイントを収録。さらに令和8年度の出題傾向・国土交通行政の重点施策・改訂コンピテンシーから導出した予想問題6テーマ（担い手×建設DX／気候変動適応・防災／インフラ老朽化・AM／カーボンニュートラル・GX／国土形成・地域づくり／インフラDX・データ活用）を収録。各テーマは最重要課題の選び方で分岐するA案・B案の2バージョン併記で、自分の専門・経験に近い案を選べる。各記事に印刷用PDF付き（全11記事）。',
  ...
  'pe-construction-road-magazine': {
    ...
    description:
      '技術士第二次試験 建設部門「道路」選択科目の令和3〜7年度を、II-1（全4設問）・II-2（両選択肢）・III（両問題）の全選択肢でフル解答した模範解答集（5年分 × 3区分 ＝ 15記事）。道路科目の合格者かつ元・地方自治体の土木職（発注者）の視点で、各記事に設問全文（出典明記）・設問構成と論述方針・フル模範解答・採点者が見るポイントを収録。さらに令和8年度の出題傾向・国土交通行政の重点施策・改訂コンピテンシーから導出した予想問題＋フル模範解答（II-1/II-2/III の3記事）を収録した試験直前対策付き（全18記事）。各記事に印刷用PDF付き。',
  ...
  'pe-construction-geotechnical-magazine': {
    ...
    published: false,
    noteUrl: '',
    title: '技術士 建設部門 2次｜土質及び基礎 選択科目 R8予想 模範解答集',
    description:
      '技術士第二次試験 建設部門「土質及び基礎」選択科目の令和8年度 予想問題＋フル模範解答集（II-1/II-2/III の3記事）。過去問7年分の出題傾向・国土交通行政の重点施策（国土強靱化・防災減災・インフラ老朽化対策）・改訂コンピテンシーから導出した予想問題を、II-1（全4設問＝締固め・圧密沈下・液状化判定・基礎形式選定）・II-2（軟弱地盤対策／近接施工）・III（地震防災／既設基礎の維持管理耐震補強）の全選択肢でフル解答。元・地方自治体の土木職（発注者）として土質・基礎構造物の設計発注・施工監督・地盤調査に携わった視点で、各記事に予想問題・予想の根拠・設問構成と論述方針・フル模範解答・採点者が見るポイントを収録した試験直前対策です。',
    shortTitle: '建設部門2次｜土質基礎 R8予想',
    shortDescription:
      'R8予想 の II-1/II-2/III 全3記事。土質・基礎を発注者視点でフル解答（試験直前対策）。',
    imageUrl: '/images/magazines/pe-construction-bk-05-geotechnical-cover.webp',
    price: '予想3記事（単品¥500）',
    badge: 'note 限定',
  },
  'pe-construction-steel-concrete-magazine': {
    ...
    published: false,
    noteUrl: '',
    title: '技術士 建設部門 2次｜鋼構造及びコンクリート 選択科目 R8予想 模範解答集',
    description:
      '技術士第二次試験 建設部門「鋼構造及びコンクリート」選択科目の令和8年度 予想問題＋フル模範解答集（II-1/II-2/III の3記事）。過去問7年分の傾向・国交省の重点施策（インフラ老朽化対策・国土強靱化・2050カーボンニュートラル）・改訂コンピテンシーから導いた予想問題を、II-1（疲労・溶接継手・中性化塩害・ASR）・II-2（鋼橋／コンクリート橋の補修補強）・III（予防保全と更新／脱炭素・低炭素材料）の全選択肢でフル解答。元・地方自治体の土木職（発注者）として橋梁等の鋼・コンクリート構造物の設計発注・施工監督・維持管理に携わった視点で、各記事に予想問題・予想の根拠・設問構成と論述方針・フル模範解答・採点者が見るポイントを収録した試験直前対策です。',
    shortTitle: '建設部門2次｜鋼コン R8予想',
    shortDescription:
      'R8予想 の II-1/II-2/III 全3記事。鋼構造・コンクリートを発注者視点でフル解答（試験直前対策）。',
    imageUrl: '/images/magazines/pe-construction-bk-06-steel-concrete-cover.webp',
    price: '予想3記事（単品¥500）',
    badge: 'note 限定',
  },
  'pe-construction-environment-magazine': {
    ...
    description:
      '技術士第二次試験 建設部門「建設環境」選択科目の令和3〜7年度を、II-1（全4設問）・II-2（両選択肢）・III（両問題）の全選択肢でフル解答した模範解答集（5年分 × 3区分 ＝ 15記事）。元・地方自治体の土木職（発注者）として環境影響評価・騒音振動・水質保全・建設リサイクル等の業務発注・施工監督に携わった視点で、各記事に設問全文（出典明記）・設問構成と論述方針・フル模範解答・採点者が見るポイントを収録。さらに令和8年度の出題傾向・国土交通行政の重点施策・改訂コンピテンシーから導出した予想問題＋フル模範解答（II-1/II-2/IIIの3記事）を収録した試験直前対策付き（全18記事）。各記事に印刷用PDF付き。',
    shortTitle: '建設部門2次｜建設環境 模範解答集',
    shortDescription:
      'R03〜R07＋R8予想 の II-1/II-2/III 全18記事。建設環境を発注者視点でフル解答。',
