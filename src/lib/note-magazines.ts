...
const MAGAZINES_RAW = {
  ...
  // 全2巻構成のうち「施工管理・法規編」（6分野）が先行完成。「土木一般・共通工学編」（土工・建設機械・
  // コンクリート工・基礎工・測量・解体工事）は未着手。2巻揃ってから有料マガジン化を検討する
  // （価格・単品/バンドルの別はユーザー判断待ち。現状は無料の単発記事として公開準備）。
  'civil-1-reading-guide': {
    id: 'civil-1-reading-guide',
    published: false,
    noteUrl: '',
    title: '1級土木 テキスト精読ガイド｜施工管理・法規編（出題頻度・優先度つき）',
    description:
      '1級土木施工管理技士 第1次検定「施工管理」5分野（施工計画・工程管理・品質管理・安全管理・環境保全）と法規を、出題頻度・優先度つきで整理した精読ガイド。各テーマから doboku-note の詳細解説記事へ直リンク。全2巻予定の第1巻。',
    shortTitle: '1級土木 精読ガイド｜施工管理・法規編',
    shortDescription: '施工管理5分野＋法規を出題頻度・優先度で整理。詳細解説への直リンクつき。',
    badge: 'note 限定',
