...
const MAGAZINES_RAW = {
  ...
  'essay-geotechnical-consultant-magazine': {
    ...
    shortDescription: '令和3〜7年度、各年A・Bの2案。地盤調査・基礎設計の受注者として、技術品質・社内工程・技術者配置を統括する立場の答案モデル。',
    price: '¥1,980',
    badge: 'note 実務立場別 教材',
  },
  ...
  'essay-maintenance-contractor-magazine': {
    ...
    shortDescription: '令和3〜7年度、各年A・Bの2案。維持修繕・更新工事の施工者として、供用条件・施工品質・安全・要員配置を統括する立場の答案モデル。',
    price: '¥1,980',
    badge: 'note 実務立場別 教材',
  },
  ...
  'essay-complete-pack': {
    ...
    title: '総監記述式 完全パック｜型×設問3×予想×全14ペルソナ模範論文＋精読＋択一PDF 全部入り',
    description:
      '技術士総監 記述式（必須科目Ⅰ）対策の全部入り。クロストレードオフ（5管理対立の型）＋設問3国家施策バンク（弾薬）＋R8予想問題集（演習）＋模範論文 全14ペルソナ（受注者4＋自治体10・フル実演）＋5管理テキスト精読ガイドを1パックに収録。収録の設問(3)国家施策バンクは、R8本試験テーマ「地方創生」を6/1公開で事前収録した実績があります。自分の専門分野が必ず入る網羅保証。2026年9月に択一 過去問PDF 令和・平成（全680問・全選択肢解説）も追加収録（価格据置）。単品合計¥46,600相当。',
    shortTitle: '記述式 完全パック',
    shortDescription:
      '型×設問3×予想×全14ペルソナ模範論文＋精読＋択一PDFの全部入り。総監対策の決定版バンドル。',
    price: '¥9,800',
    badge: 'note 限定',
  ...
  // 2026-09-16 無料 2 記事として公開（施工管理・法規編 n653cd1b3ee71／土木一般・共通工学編 nd4320a66d09f）。
  // 一次の入口記事＝一次過去問 PDF（civil-1-takuitsu-pdf）への送客。noteUrl は第 1 巻。
  ...
  // 2級 二次まるごとパック（2026-09-17 新設・note key m2d9a069b6f87）。2級は 7 SKU あってパックが無かった（売上実測で全部パックが売上 28%）。
  // 想定工事バンク 61＋過去問模範答案集 5＋完成答案集 3＋学科記述出る順 5（--from）＋暗記・模試3回・出題分析（--notes）＝77 記事を API 実体確認。
  // 単品合計 ¥15,060 → ¥8,800（約42%OFF）。サイト CTA は無料の案内記事（landingUrl）へ着地。
  'civil-2-niji-marugoto-pack': {
    ...
    description:
      '2級土木施工管理技士 第2次検定を、経験記述（問題1）と学科記述（問題2〜9）の両面からまるごと対策する最上位パック。想定工事バンク（60工事×5管理）・過去問模範答案集（R03-R07）・完成答案集・二次学科記述 テーマ別出る順・直前暗記ノート・R8予想模試3回・出題分析の7点を1つに統合。単品合計¥15,060が¥8,800。個別添削や月例予想での伴走が欲しい方は、メンバーシップ「土木セコカン合格ラボ」が別途あります。※改変前提のテンプレートで、合格を保証するものではありません。',
    shortTitle: '2級土木 二次検定まるごとパック',
    shortDescription: '想定工事バンク＋過去問模範答案＋完成答案＋学科記述出る順＋直前暗記＋模試3回＋出題分析の7点。単品合計¥15,060が¥8,800。',
    price: '¥8,800（二次まるごと・単品合計¥15,060）',
    badge: 'note 限定',
  ...
  // 実務立場別全32答案集から、立場ごとの既存4答案＋無料ガイドを再収録。新作答案との誤認を避ける。
  ...
  'cce-persona-civil-contractor-pack': {
    id: 'cce-persona-civil-contractor-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/m8af7494fcabf',
    title: '主任技士 小論文｜土木施工の4テーマ',
    description: 'ゼネコン土木施工の実務からコンクリート主任技士の小論文を組み立てたい方へ。品質管理・耐久性・環境配慮・施工トラブルの4テーマを収録。受入れ・打込み・養生・施工体制を、施工者の責任範囲で書くための想定問題、フル模範小論文、チェックポイント、置換ガイドをまとめました。有料4記事＋無料の立場選択ガイド1記事です。答案は仮想の実務モデルで、著者自身の職歴を意味しません。実務立場別全32答案集・まるごとパックと同じ記事を収録しています。これらの購入者は追加購入不要です。',
    shortTitle: '主任技士 土木施工 小論文4テーマ',
    shortDescription: '受入れ・打込み・養生・施工体制を、施工者の責任範囲で書く。品質管理・耐久性・環境配慮・施工トラブルの4答案と無料ガイド。',
    price: '¥2,980（5記事セット・有料4記事＋無料ガイド）',
    badge: 'note 実務立場別 教材',
  },
  ...
  'cce-persona-maintenance-pack': {
    ...
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/m842b2a1c7c1f',
    title: '主任技士 小論文｜維持管理補修の4テーマ',
  ...
  'cce-persona-owner-pack': {
    id: 'cce-persona-owner-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/ma33ab3cc69e2',
    title: '主任技士 小論文｜発注者の4テーマ',
    description: '発注者・監督員の実務からコンクリート主任技士の小論文を組み立てたい方へ。品質管理・耐久性・環境配慮・施工トラブルの4テーマを収録。要求性能・監督・検査・協議を軸に、施工者と役割を分けて書くための想定問題、フル模範小論文、チェックポイント、置換ガイドをまとめました。有料4記事＋無料の立場選択ガイド1記事です。答案は仮想の実務モデルで、著者自身の職歴を意味しません。実務立場別全32答案集・まるごとパックと同じ記事を収録しています。これらの購入者は追加購入不要です。',
    shortTitle: '主任技士 発注者 小論文4テーマ',
    shortDescription: '要求性能・監督・検査・協議を軸に、施工者と役割を分けて書く。品質管理・耐久性・環境配慮・施工トラブルの4答案と無料ガイド。',
    price: '¥2,980（5記事セット・有料4記事＋無料ガイド）',
    badge: 'note 実務立場別 教材',
  },
  ...
  'cce-persona-testing-pack': {
    id: 'cce-persona-testing-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/m8bc94bb05c0a',
    title: '主任技士 小論文｜試験検査機関の4テーマ',
    description: '試験・検査機関の実務からコンクリート主任技士の小論文を組み立てたい方へ。品質管理・耐久性・環境配慮・施工トラブルの4テーマを収録。試験計画・測定・精度管理・報告を、検査機関の判断として書くための想定問題、フル模範小論文、チェックポイント、置換ガイドをまとめました。有料4記事＋無料の立場選択ガイド1記事です。答案は仮想の実務モデルで、著者自身の職歴を意味しません。実務立場別全32答案集・まるごとパックと同じ記事を収録しています。これらの購入者は追加購入不要です。',
    shortTitle: '主任技士 試験検査機関 小論文4テーマ',
    shortDescription: '試験計画・測定・精度管理・報告を、検査機関の判断として書く。品質管理・耐久性・環境配慮・施工トラブルの4答案と無料ガイド。',
    price: '¥2,980（5記事セット・有料4記事＋無料ガイド）',
    badge: 'note 実務立場別 教材',
  },
  ...
  // コンクリート主任技士の最上位アンカー（2026-09-04 新設）。択一（配合計算12問・R8予想50問）と
  // 小論文（型の入門5本・実務立場別33記事）を1つに束ねた買い切り。単品合計 ¥11,920 → ¥9,800。
  // 目的は値上げでなく**天井の新設**: 既存 SKU は据え置いたまま上に ¥9,800 を置き、
  // 上位版 cce-essay-persona-pack ¥5,980 を中位に見せる（civil ¥11,800・総監 ¥9,800 と同型）。
  // コンクリート線は実売0（sales-log 実測 2026-09-04）＝失う実売が無いので下方リスクなしに単価上限だけ上げる。
  ...
  'cce-marugoto-pack': {
    ...
    description:
      'コンクリート主任技士の四肢択一と小論文を1つで対策する最上位パック。柱①小論文 評価される答案の型＋テーマ別 模範答案集（解法ガイド＋耐久性・品質管理・環境配慮・施工トラブルのフル模範小論文）、柱②実務立場別 小論文集（生コン工場・プレキャスト工場・ゼネコン土木/建築・発注者・設計コンサル・試験検査機関・維持管理の8立場×4テーマ＝32答案）、柱③令和8年度 四肢択一 予想50問（8分野・全選択肢の正誤理由・分野別採点表）、柱④配合計算 実戦演習12問（途中式・全誤答肢解説）を統合する。想定問題・予想問題はオリジナルで、実在過去問の逐語再現ではない。固有数値は置換前提。※合格を保証するものではありません。2026年9月に直前暗記ノート（一問一答157問）を追加収録（価格据置・単品合計¥12,900）。',
    shortTitle: 'コンクリート主任技士 まるごとパック',
    shortDescription:
      '択一（配合計算・R8予想50問）と小論文（答案の型・実務立場別32答案）を1つに束ねた最上位パック。単品でそろえるより割安。',
    price: '¥9,800（42記事セット・単品合計¥12,900）',
    badge: 'note 限定 教材',
  ...
  'tankan-oral-complete': {
    ...
    shortTitle: '総監口頭試験 完全準備システム｜想定25問と立場別回答例',
    shortDescription: '総監の必須科目に対応する口頭試験の準備教材。独自の4領域で整理した想定25問、準備ロードマップ、発注者・コンサル・施工者の架空の回答例、事実の記入欄と直前チェックリストを収録。実際の試問の再現ではありません。',
    price: '¥2,980',
    badge: 'note 限定 教材',
  },
  ...
  'rccm-mondai1-water': {
    ...
    shortDescription: '上水道の実務を整理する業務経験の記入例2本と置換ガイド。各例は1業務を掘り下げる練習用の架空モデルであり、公式解答欄の再現や著者の実体験ではありません。自分が担当した事実・責任・判断に置き換え、受験当日の設問と入力欄に合わせて使います。',
    price: '¥1,980',
    badge: 'note 限定 教材',
  },
  ...
  'rccm-mondai1-sewer': {
    ...
    shortDescription: '下水道の実務を整理する業務経験の記入例2本と置換ガイド。各例は1業務を掘り下げる練習用の架空モデルであり、公式解答欄の再現や著者の実体験ではありません。自分が担当した事実・責任・判断に置き換え、受験当日の設問と入力欄に合わせて使います。',
    price: '¥1,980',
    badge: 'note 限定 教材',
  },
  ...
  'rccm-mondai1-geotechnical': {
    ...
    shortDescription: '土質及び基礎の実務を整理する業務経験の記入例2本と置換ガイド。各例は1業務を掘り下げる練習用の架空モデルであり、公式解答欄の再現や著者の実体験ではありません。自分が担当した事実・責任・判断に置き換え、受験当日の設問と入力欄に合わせて使います。',
    price: '¥1,980',
    badge: 'note 限定 教材',
  },
  ...
  // RCCM まるごとパック（2026-09-16 新設・note key me2b526bf77f4）。問題I・II・III・IV-1を対象とし、IV-2は含まない。
  // 論文と共通知識を束ねた商品。問題III マガジン 7 記事（序章含む）＋問題I テンプレ＋択一予想50問＝9 記事
  // を API 実体確認。2026-09-17 に直前暗記ノート（n6a82c25cc9de）を追加収録し 10 記事・単品合計 ¥7,920 → ¥5,980（約24%OFF）。
  'rccm-marugoto-pack': {
    id: 'rccm-marugoto-pack',
    published: true,
    noteUrl: 'https://note.com/dobokunote/m/me2b526bf77f4',
    title: 'RCCM まるごとパック（問題I・II・III・IV-1 対応・模範論文集＋業務経験論文テンプレ＋択一予想50問＋直前暗記ノート）',
    description:
      '問題I 業務経験、問題II 共通知識、問題III 管理技術力、問題IV-1 基礎的技術知識をまとめたパック。問題IV-2の部門別専門技術知識は含みません。2026年度 公開6テーマの模範論文集（序章無料）、業務経験論文の2,400字テンプレと3部門の記入例、択一の出題範囲マップ＋予想50問、択一 直前暗記ノート（一問一答159問）を収録。過去問は事務局非公開のため全て自作。単品合計¥7,920が¥5,980。',
    shortTitle: 'RCCM まるごとパック',
    shortDescription: '問題I・II・III・IV-1 対応。模範論文集＋業務経験論文テンプレ＋択一予想50問＋直前暗記ノート、単品合計¥7,920が¥5,980。',
    price: '¥5,980（問題I・II・III・IV-1 対応・単品合計¥7,920、約24%OFF）',
    badge: 'note 限定 まるごとパック',
    ctaCatch: 'RCCMの論文と共通知識をまとめて練習',
