...
const MAGAZINES_RAW = {
  ...
  // RCCM まるごとパック（2026-09-16 新設・note key me2b526bf77f4）。試験A（問題I・II）＋試験B（問題III・IV）の
  // 4 問すべての教材を束ねた最上位アンカー。問題III マガジン 7 記事（序章含む）＋問題I テンプレ＋択一予想50問＝9 記事
  ...
  'rccm-marugoto-pack': {
    ...
    title: 'RCCM まるごとパック（問題I〜IV 全対応・模範論文集＋業務経験論文テンプレ＋択一予想50問＋直前暗記ノート）',
    description:
      'RCCM資格試験の試験A（問題I 業務経験論文・問題II 択一）と試験B（問題III 管理技術力・問題IV 択一）、4問全部の教材を1つに束ねたパック。2026年度 公開6テーマの模範論文集（序章無料）、業務経験論文の2,400字テンプレと3部門の記入例、択一の出題範囲マップ＋予想50問、択一 直前暗記ノート（一問一答159問）を収録。過去問は事務局非公開のため全て自作。単品合計¥7,920が¥5,980。',
    shortTitle: 'RCCM まるごとパック',
    shortDescription: '問題I〜IV 全対応。模範論文集＋業務経験論文テンプレ＋択一予想50問＋直前暗記ノート、単品合計¥7,920が¥5,980。',
    price: '¥5,980（問題I〜IV 全対応・単品合計¥7,920、約24%OFF）',
    badge: 'note 限定 まるごとパック',
    ctaCatch: '試験Aも試験Bも、RCCMはこれ1つで',
