...
export const generalSidebar: SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      'general/common-specs/common',
      'general/common-specs/materials',
      {
        type: 'category',
        label: '第3編 土木工事共通編',
        items: [
      ...
      },
      {
        ...
        label: '第6編 河川編',
        items: [
          'general/common-specs/river-01',
          'general/common-specs/river-02',
        ],
      },
      'general/common-specs/coastal',
      'general/common-specs/erosion',
      'general/common-specs/dam',
      {
        type: 'category',
        label: '第10編 道路編',
        items: [
