 ...
 * 真実源: docs/operations/09_BuildJob収益最大化スプリント.md（P0）。
 */
 ...
 */
export function resolveCareerArticleEndCard(
  slug?: string,
  ...
  if (resolveCareerSidebarAd().trackLabel === "BuildJob-sidebar") {
    return resolveBuildJobCopy(slug, need);
  }
  ...
  return {
    ...
    cta: resolveNeedCta(slug, "consultation", "無料で求人を見る", need),
  };
}
