import { BookOpen, NotebookPen, PencilLine } from 'lucide-react';
 ...
 *  - `public/images/brand/{note,coconala}.svg` に原本を置き、そのまま原寸比で出す
 ...
 */
export type ServiceChannel = 'site' | 'note' | 'coconala';
