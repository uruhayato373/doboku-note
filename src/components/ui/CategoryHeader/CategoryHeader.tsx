  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-cyan-50 dark:from-primary-950 dark:via-gray-900 dark:to-cyan-950 rounded-card-hero p-8 md:p-12 mb-16 transition-all duration-500 hover:shadow-2xl dark:hover:shadow-primary-900/20">
      ...
      <div className="absolute inset-0 opacity-10 dark:opacity-20">
        <div className="absolute top-0 left-0 w-32 h-32 bg-primary-400 rounded-sm blur-3xl"></div>
        <div className="absolute top-1/2 right-0 w-24 h-24 bg-cyan-400 rounded-sm blur-2xl"></div>
        <div className="absolute bottom-0 left-1/3 w-20 h-20 bg-primary-300 rounded-sm blur-2xl"></div>
      </div>
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 mb-8">
          <div className="relative">
            <div className="absolute inset-0 bg-primary-400 dark:bg-primary-500 rounded-sm blur-xl opacity-30 animate-pulse"></div>
            <div className="relative bg-gradient-to-br from-primary-500 to-cyan-500 w-20 h-20 md:w-24 md:h-24 rounded-sm flex items-center justify-center shadow-2xl transform hover:scale-110 transition-all duration-300">
              {icon}
            </div>
          </div>
