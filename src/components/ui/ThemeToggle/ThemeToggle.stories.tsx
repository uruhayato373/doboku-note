    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="text-center">
          ...
          <div className="w-9 h-9 rounded-sm bg-gray-700 hover:bg-gray-600 transition-colors duration-200 flex items-center justify-center">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <div className="text-center">
          ...
          <div className="w-9 h-9 rounded-sm bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 transition-colors duration-200 flex items-center justify-center ring-2 ring-primary-500 ring-offset-2">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        <div className="text-center">
          ...
          <div className="w-9 h-9 rounded-sm bg-gray-200 dark:bg-gray-700 animate-pulse" />
        </div>
