      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <a
            ...
            target="_blank"
            rel={NOTE_LINK_REL}
            className="mt-4 inline-flex items-center gap-2 px-3.5 py-2 rounded-md bg-[var(--accent)] text-[var(--paper)] text-sm font-bold shadow-sm hover:bg-[var(--accent)] transition-colors"
          >
