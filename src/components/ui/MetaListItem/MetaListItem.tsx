/**
 * MetaCard 内のリスト行（→ 矢印 + タイトル + 出典右寄せ + 説明）。
 *
 ...
 *     <MetaListItem title={title} source={source} description={description} />
 *   </a>
 *
 *   // リンクなし（書籍参照等）
 *   <div>
 *     <MetaListItem title={title} source={source} description={description} plain />
 *   </div>
 */
...
export default function MetaListItem({ title, source, description, plain = false }: MetaListItemProps) {
