...
export default function Hero({ articleCount, lastUpdated }: HeroProps) {
  return (
    <section className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-10 pt-16 sm:pt-24 pb-10 sm:pb-16 text-center">
      ...
      <div className="mt-8 sm:mt-9 flex items-center justify-center gap-3 flex-wrap">
        <a
          href="#exams"
        ...
        <a
          href="/links"
          data-cta="note"
          data-cta-label="home-hero-links"
          className="inline-flex items-center gap-2 font-mono text-[12px] tracking-wider uppercase text-[var(--accent)] border border-[var(--accent)] px-5 py-3 rounded-full hover:bg-[var(--accent-fill)] transition-colors"
        >
          <span>note 教材を見る</span>
        </a>
      </div>
