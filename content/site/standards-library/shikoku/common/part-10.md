# 土木工事共通仕様書 令和8年3月 — PDF pages 451-500
...
第6節   法面工
 ...
 2.適用規定
      受注者は、法面の施工にあたって、「道路土工－切土工・斜面安定工指針 3設計と
   施工」（日本道路協会、平成21年6月）、「のり枠工の設計・施工指針 第8章 吹付枠
   工、第9章 プレキャスト枠工、第10章 現場打ちコンクリート枠工、第11章 中詰工」
...
```text
   ...
   同解説 第7章 施工」（地盤工学会、平成24年5月）の規定による。これ以外の施工方
...
2.ミキサーの練混ぜ性能試験
    受注者は､JIS A 8603-2（コンクリートミキサー第2部：練混ぜ性能試験方法）によ
  りミキサーの練混ぜ性能試験を行い、十分な性能を有することを確かめてから使用す
  るものとし、試験結果は整理・保管するとともに、監督職員または検査職員から請求
  があった場合は速やかに提示しなければならない。また、試験の結果、異常が発見さ
  れた場合は速やかに監督職員へ報告しなければならない。
3.使用機器
...
（2）受注者は､強制練りミキサーを用いる場合は、JIS A 8603-2（コンクリートミキサ
  ー第2部：練混ぜ性能試験方法）により練混ぜ性能試験を行い、十分な性能を有す
  ることを確かめるものとし、試験結果は整理・保管するとともに、監督職員または
  検査職員から請求があった場合は速やかに提示しなければならない。また、試験の
  結果、異常が発見された場合は速やかに監督職員へ報告しなければばらない。
6.練混ぜ時間の範囲
