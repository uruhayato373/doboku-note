...
- 令和元〜7年度の基礎科目・適性科目・専門科目 全560問を、科目をまたいで1冊で通しで回せます
- 各選択肢がなぜ正しい／誤りかを根拠から確認できるので、初見の肢にも対応できる地力がつきます
...
この教材は、**令和元年度から令和7年度までの7年分**について、基礎科目210問・適性科目105問・専門科目（建設部門）245問の**合計560問を1問残らず収録**し、各選択肢の論点を解説したA4印刷用PDFです。3科目を横断して一冊で回せるよう再編集しています。

なお、令和7年度の専門科目Ⅲ-13は、日本技術士会が公表した正答に番号の掲載がありません。本教材では問題を省略せず収録し、正答を断定しない形で5肢の論点を整理しています。したがって、**560問収録・559問採点＋1問は採点対象外**です。
...
- **559問は全選択肢に正誤の理由を明記**し、公式正答番号のない1問も5肢の論点を整理
- 計算問題は途中式つき、組合せ問題は表で整理
- A4・通しページ番号つきの印刷用PDF、出典・著作権・免責を明記
- 11週間の学習計画・周回記録・3科目の答案記入シートつき
...
> 選択肢1　ア：合理的／イ：使用性能／ウ：施工計画／エ：詳細設計

> 選択肢3　ア：合理的／イ：要求性能／ウ：構造計画／エ：構造詳細

> 選択肢5　ア：合理的／イ：要求性能／ウ：構造計画／エ：詳細設計
...
このように、正答番号ではなく「5が違うのはエが構造詳細だから」まで言えるようにするのが、本番で崩れない解き方です。公式正答番号のある559問はこの粒度で解説し、残る1問も正答を断定せず全肢の論点を整理しています。

## PDF のダウンロードと使い方

ここから先で、全560問・全選択肢解説のA4印刷用PDF（この記事の末尾に添付）をダウンロードできます。PDFには、11週間の学習計画、周回記録、基礎・適性・専門科目の答案記入シートも収録しています。以下は、3科目を効率よく仕上げる回し方です。
...
- **11〜9週前｜専門科目245問・1周目** — 得意分野と捨て候補を分ける
- **8〜7週前｜基礎科目210問・1周目** — 5群すべてを解き、弱い群を特定する
- **6週前｜適性科目105問・1周目** — 技術士法・倫理の誤り肢を説明できる状態にする
- **5〜4週前｜3科目の誤答だけ2周目** — 原因を「知識・読違い・計算・時間」に分類する
- **3〜2週前｜年度別に本番時間で演習** — 各科目の基準点を安定して超える
- **1週前｜誤答と法令・公式だけ確認** — 新しい教材を増やさず、再誤答を潰す

## 周回記録シート

PDFには、そのまま印刷して使える周回記録シートを収録しています。日付、年度・科目、採点数、正答数に加え、**同じ原因で繰り返し落としていないか**を見るため、知識不足・読違い・計算ミス・時間切れ・次回確認日の欄を設けています。

さらに、基礎30問、適性15問、専門35問の答案記入シートも収録しています。基礎は解答する15問、専門は解答する25問だけを記入することで、本番と同じ「選ぶ問題／捨てる問題」の判断まで練習できます。

誤答の横には、長い解説を書き写さず「知らなかった語句」「読み落とした限定語」「使う公式」「次に切る時間」のどれかを1行だけ残します。2周目は、その1行を隠して説明できるかを確認してください。
