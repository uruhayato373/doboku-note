...
なお、設問対応や文章作法そのものは別の[書き方ガイド](https://doboku-note.com/exam/pe-construction/guide/pe-secondary-essay-guide?utm_source=note&utm_medium=referral&utm_campaign=pe-construction-toan-kousei)に譲り、本記事はその実践編として「構成の型」に集中します。
...
系統別の出題傾向は[必須科目Iのテーマ別出題傾向](https://doboku-note.com/exam/pe-construction/keywords/required-exam-themes?utm_source=note&utm_medium=referral&utm_campaign=pe-construction-toan-kousei)で確認できます。
...
詳細は[令和8年度コンピテンシー改訂](https://doboku-note.com/exam/pe-construction/guide/competency-revision-r8?utm_source=note&utm_medium=referral&utm_campaign=pe-construction-toan-kousei)を参照してください。
