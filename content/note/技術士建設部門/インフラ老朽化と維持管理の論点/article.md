...
改訂の答案への影響は[令和8年度のコンピテンシー改訂](https://doboku-note.com/exam/pe-construction/guide/competency-revision-r8?utm_source=note&utm_medium=referral&utm_campaign=pe-roukyuuka&utm_content=r8-revision)で詳しく整理しています。

維持管理・更新の論点を用語単位で網羅するなら、[インフラ維持管理・更新の論点キーワード集](https://doboku-note.com/exam/pe-construction/keywords/iji-kanri-ronbun-keyword?utm_source=note&utm_medium=referral&utm_campaign=pe-roukyuuka&utm_content=kw-iji-kanri)もサイトにあります。
