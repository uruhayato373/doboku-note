...
反映点：地山調査データ・計測データの活用による課題定義（データ活用）、住民・関係機関・発注者との合意形成（ステークホルダー）、社会・経済・環境の三側面での施設保全と安全確保（持続可能な成果）。[コンピテンシー改訂の解説](https://doboku-note.com/exam/pe-construction/guide/competency-revision-r8?utm_source=note&utm_medium=referral&utm_campaign=pe-construction-secondary)
