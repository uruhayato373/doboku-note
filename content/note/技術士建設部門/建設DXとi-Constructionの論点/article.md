...
論文の全体像から押さえたい場合は、[記述式論文の書き方ガイド](https://doboku-note.com/exam/pe-construction/guide/pe-secondary-essay-guide?utm_source=note&utm_medium=referral&utm_campaign=pe-dx&utm_content=essay-guide)もあわせて読むと骨組みが固まります。
...
3次元データを誰がどう共有し、住民や関係機関との合意形成にどう生かすかまで踏み込めると、改訂後の評価軸に正面から応えられます。必須科目Iの系統と年度別の出題傾向は、[必須科目Iの頻出テーマ系統](https://doboku-note.com/exam/pe-construction/keywords/required-exam-themes?utm_source=note&utm_medium=referral&utm_campaign=pe-dx&utm_content=exam-themes)で整理しています。

建設DX・担い手の論点を用語単位で押さえるなら、[担い手確保・生産性向上の論点キーワード集](https://doboku-note.com/exam/pe-construction/keywords/ninaite-dx-ronbun-keyword?utm_source=note&utm_medium=referral&utm_campaign=pe-dx&utm_content=kw-ninaite-dx)もサイトにあります。
