...
本記事が解答するのは、技術士総合技術監理部門 令和4年度 必須科目（記述式）I-2「DX推進」です。前文（DXとデジタル技術の利用の区別など出題の背景）の全文は [令和4年度 総監記述式 過去問解説](https://doboku-note.com/exam/pe-comprehensive-management/past-exams/r04-secondary?utm_source=note&utm_medium=referral&utm_campaign=essay-road-consul-r04) に掲載しています。ここでは解答すべき設問を再掲します。
...
- [令和4年度 総監記述式 過去問解説](https://doboku-note.com/exam/pe-comprehensive-management/past-exams/r04-secondary?utm_source=note&utm_medium=referral&utm_campaign=essay-road-consul-r04) — 必須科目の問題文全文と他ペルソナの解き方
- [5 管理間トレードオフ 頻出パターンと解決フレーム](https://doboku-note.com/exam/pe-comprehensive-management/guide/management-tradeoffs?utm_source=note&utm_medium=referral&utm_campaign=essay-road-consul-r04) — 段階的実施・合意形成・LCA などフレーム集
