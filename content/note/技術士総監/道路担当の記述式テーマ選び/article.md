...
記述式で問われうるキーワードの見通しは、[R8 記述式キーワード予想](https://doboku-note.com/exam/pe-comprehensive-management/guide/r8-essay-keyword-forecast?utm_source=note&utm_medium=referral&utm_campaign=99-road-essay-theme&utm_content=essay-keyword-forecast)に整理しています。テーマを決めたあとの論点集めに使えます。
