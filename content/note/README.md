...
- **有料マガジン**（`技術士総監/magazines/`）: コア4（テキスト精読ガイド / 5管理クロストレードオフ / 設問3国家施策バンク / R8予想問題集）＋ 模範論文 17 ペルソナ（受注者7（ゼネコン・河川・道路橋梁・都市計画・土質基礎・上下水道・維持更新施工）＋自治体10分野）＋ 完全パック（2段ラダー: コアパック ¥5,480 / 全記事パック ¥9,800・2026-09-19 に収録漏れ61記事と新3ペルソナ15記事を補い全202記事）
- **無料リード磁石**: 白書R7完全対応集・総監メリット完全マップ・R8予想問題・「立場別模範論文の選び方」（17ペルソナの公開案内）
- **口頭試験**: 完全準備（`tankan-oral-complete`・¥2,980・想定25問とPDF・2026-09-19公開）。記述式完全パックとは別売。
...
- **口頭試験**: `pe-construction-oral-guide`（¥1,980・想定33問とPDF・2026-09-19公開）。
...
- **有料**（`RCCM/magazines/`）: 問題III 管理技術力｜2026年度 公開6テーマ 模範論文集（`rccm-mondai3-magazine`・¥3,480・単品¥780×6＋序章無料）／問題I 業務経験論文テンプレ（`rccm-mondai1-template`・¥1,980）／問題II・IV-1 論点集と予想50問（`rccm-takuitsu-yosou-50`・¥1,480）／択一 直前暗記ノート（`rccm-anki-note`・¥980・2026-09-17）／まるごとパック（`rccm-marugoto-pack`・¥5,980・問題Iの追加3部門教材も含む全13記事・2026-09-19更新）。2026 年度は CBT 試験期間 9/1〜10/31 の直前期に投入
- **問題I 部門別記入例**: 上水道・下水道・土質及び基礎（各¥1,980・各2例・PDF付き・2026-09-19公開）。既存テンプレの道路・河川砂防・鋼構造コンクリートと合わせ6部門。2,400字は練習用の目安。問題IV-2は対象外。
...
- **有料マガジン**: 問題A・問題B 模範答案集（`cd-essay-magazine`・¥2,980・解法ガイド1本＋オリジナル想定問題の答案7本、全8記事）。公開済み。実価格とURLは `src/lib/note-magazines.ts` を参照。
- **公開済み（2026-09-20）**: 構造物別8ケース、道路・橋梁、水・地下、建築・施設、問題A、問題B、記述式完全パックの7商品。新規原稿8本を一度だけ持ち、同一記事を各マガジンへ再収録する。
- **2026-11-26以降**: 四肢択一演習98問PDFと、択一・記述式まるごとパック。Kindle `g-01` のKDP Select現行期間が2026-11-25までのため、それ以前は販売しない。98問PDFは2026-09-20にnote下書き（`n4acd2c7a2f13`）へPDF添付まで完了し、まるごとパックも掲載文とカバーを準備済み。商品構成と公開順は `コンクリート診断士/noteコンテンツ計画.md` を参照。
