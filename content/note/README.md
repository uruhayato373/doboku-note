...
- **公開準備中**: 構造物別8ケース、道路・橋梁、水・地下、建築・施設、問題A、問題B、記述式完全パックの7商品。新規原稿8本を一度だけ持ち、同一記事を各マガジンへ再収録する。技術レビュー完了後に公開する。
- **2026-11-26以降**: 四肢択一演習98問PDFと、択一・記述式まるごとパック。Kindle `g-01` のKDP Select現行期間が2026-11-25までのため、それ以前は販売しない。商品構成と公開順は `コンクリート診断士/noteコンテンツ計画.md` を参照。
