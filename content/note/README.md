...
- **公開済み（2026-09-20）**: 構造物別8ケース、道路・橋梁、水・地下、建築・施設、問題A、問題B、記述式完全パック、四肢択一演習98問PDF、択一・記述式まるごとパックの9商品。新規原稿8本を一度だけ持ち、同一記事を各マガジンへ再収録する。実価格とURLは `src/lib/note-magazines.ts`、商品構成は `コンクリート診断士/noteコンテンツ計画.md` を参照。
