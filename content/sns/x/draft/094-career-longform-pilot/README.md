...
|---|---|---|---|
| 1 | 2026-09-22 05:40（初回 09-06 19:50） | 2026-09-23 07:40 | 施工管理を辞めたい理由の切り分け |
| 2 | 未公開（09-13・09-16 の枠を逸失・手動復旧待ち） | Article URL 確定後に枠を決める | 1級土木の市場価値 |
| 3 | 2026-09-20 09:20（初回 09-20 19:35） | 2026-09-21 07:15 | 現場以外も含むキャリアパス |
| 4 | 2026-09-27 05:40（初回 09-27 20:15） | 2026-09-28 07:50 | 2級・若手のキャリア設計 |

> [!warning] 2026-09-20 に Article を夕方から早朝へ移した理由
> Codex のローカル自動化は Mac がスリープ中は発火せず、起床時（05:30 前後）にまとめて遅延実行される。09-06・09-13・09-16 の 3 回とも翌朝 04:50〜05:30 に走り、`x-article:publish` の公開窓（15 分前〜120 分後）を外れて exit 1 で停止した（`~/.codex/automations/x-article-*/memory.md`）。同じ日のまま時刻だけ早朝へ寄せ、告知短文の枠（1 日 3 件）は動かさない。予定時刻に Mac が起きていれば定刻、寝ていても起床が 2 時間以内なら窓内で公開される。
