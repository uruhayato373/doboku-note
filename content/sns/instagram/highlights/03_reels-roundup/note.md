...
過去問パック Reels は `content/sns/instagram/{exam}/exam-packs/<year>/pack-NN/reels/video.mp4` から派生投稿される。実投稿後の URL は IG アプリから取得。

## 投稿フロー

```
1. 5 枚 PNG 確認
   node .claude/scripts/instagram/build-highlight-materials.mjs --dir content/sns/instagram/highlights/03_reels-roundup
       ↓
2. Stories 5 枚を順番に連投
...
| 情報 | 参照先 |
|---|---|
| Reels の真実源 | `content/sns/instagram/{exam}/exam-packs/<year>/pack-NN/reels/`（過去問パック）/ 将来の単独 Reels ディレクトリ |
| Reels 台本ポリシー | `.claude/knowledge/reference/ig-reels-policy.md` |
| Reels と Carousel/YT の役割分担 | `docs/marketing/01_SNS集客戦略.md` v7.1 §2 役割棲み分け表 |
