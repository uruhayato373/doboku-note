...
| `publish` | `/note-prepublish-review` ＋ `.Codex/knowledge/reference/note-essay-review-checklist.md`（ペルソナ別マガジン）／`.Codex/knowledge/reference/note-publish-enhancement.md`（記事個別） | note 公開前の品質ゲート＋公開工程 |
...
1. `--target` の slug を解決
2. `/pe-essay-review {target}` を実行（3 ペルソナ評価、レポートは `.Codex/state/pe-essay-review/` に保存）
...
- **MDX 書き込みは `.Codex/scripts/lib/mdx-io.mjs` 経由**（直接 `writeFileSync` は CRLF 混在で pre-commit reject）
...
# 添削レポートを反映
/pe-essay-cycle --mode revise --year R05 --attr river-consultant --review .Codex/state/pe-essay-review/r05-essay-river-consultant-20260514.md
...
- `.Codex/skills/authoring/pe-essay-draft/SKILL.md` — ② 模範論文 Generator
- `.Codex/skills/quality/pe-essay-review/SKILL.md` — ③ 模範論文 Evaluator（3 ペルソナ）
- `.Codex/skills/social/pe-note-plan/SKILL.md` — ④ note 有料記事 企画
- `.Codex/agents/cem-essay-writer.md` / `.Codex/agents/cem-essay-qa.md` — **note 有料マガジンの記述式模範論文の生成・採点**（本スキルの draft/review は**サイト** r0X-essay ページが対象。note 模範論文の生成・QA はこのペアが担う。ランブック＝note-essay-review-checklist.md）
- `.Codex/skills/quality/quality-cycle/SKILL.md` — キーワード/教科書版の品質サイクル（本スキルの設計元）
- `.Codex/skills/quality/note-prepublish-review/SKILL.md` — note 公開前ゲート
- `.Codex/knowledge/reference/note-essay-review-checklist.md` — **総監模範論文ペルソナ別マガジンの公開品質化 SoT**（Step 0〜6f・全ペルソナ＝R03-R07＋R8予想2記事を作成＝2026-06-16 方針転換〔旧「per-persona R8予想は作らない＝決定2026」撤回〕・note掲載文.txt・価格・_meta.yaml 廃止）
...
- `.Codex/knowledge/reference/note-publish-enhancement.md` — note 公開引き上げ 10 工程
- `AGENTS.md` ハーネス設計原則 — Generator/Evaluator 分離
