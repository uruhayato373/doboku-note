...
| コンテンツの性質 | 推定出力先 |
|---|---|
| 土木工学全般 | `.local/r2/posts/civil-general/{slug}/article.mdx` |
| 施工管理 | `.local/r2/posts/construction-management/{slug}/article.mdx` |
| 法律・憲法・キーワード | `.local/r2/posts/keywords-law/{slug}/article.mdx` |
