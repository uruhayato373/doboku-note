...
| `.local/r2/posts/civil-construction-1/textbook/**/*.mdx` `.local/r2/posts/civil-construction-1/textbook-*/article.mdx` | `/review-mobile` → `/check-mdx --rules syntax` → **`/improve-article --mode verify`** | 1級土木教科書。PDF原本との視覚＋網羅率検証込み |
| `.local/r2/posts/civil-construction-1/guide/**/*.mdx` `.local/r2/posts/civil-construction-1/guide-*/article.mdx` | `/review-mobile` → `/check-mdx --rules syntax` → **`/improve-article --mode verify`** | 1級土木ガイド。出題傾向＋過去問バックリンクチェック |
| `.local/r2/posts/civil-construction-2/textbook-*/article.mdx` | `/review-mobile` → `/check-mdx --rules syntax` → **`/improve-article --mode verify`** | 2級土木教科書。PDF原本との視覚＋網羅率検証込み（Phase 1 投入後） |
| `.local/r2/posts/civil-construction-2/guide-*/article.mdx` | `/review-mobile` → `/check-mdx --rules syntax` → **`/improve-article --mode verify`** | 2級土木ガイド。出題傾向＋過去問バックリンクチェック |
...
例:
```
.local/r2/posts/pe-comprehensive-management/risk/article.mdx
  → [review-mobile, check-mdx]

src/app/docs/[...slug]/page.tsx
  → [code-review, design-review]

docs/project/02_コンテンツ/01_記述式コンテンツ戦略.md
  → [critical-review]
```
...
# 2. 特定の1ファイル
/review .local/r2/posts/pe-comprehensive-management/business-continuity-plan/article.mdx
...
# 5. docs/ 配下の設計書
/review docs/project/02_コンテンツ/01_記述式コンテンツ戦略.md
```
...
- `.Codex/skills/quality/review-mobile/SKILL.md` ── MDX モバイル可読性
- `.Codex/skills/quality/check-mdx/SKILL.md` ── MDX 検査統合（8 rules）
- `.Codex/skills/dev/code-review/SKILL.md` ── Next.js コード品質
- `.Codex/skills/ui/design-review/SKILL.md` ── デザインシステム準拠
- `.Codex/skills/management/critical-review/SKILL.md` ── 批判的レビュー
