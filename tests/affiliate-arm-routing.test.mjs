...
//   収益の配線が無言で変わる。
//
// TS のロードは tests/lib/load-ts.mjs（esbuild transform ＋ `@/` エイリアスの再帰解決）。
// 素の transformSync だけだと bundle されないため、affiliate-creatives.ts が
// career-pathways.ts を import した時点で ERR_MODULE_NOT_FOUND になる。
...
async function loadCreatives() {
  return loadTsModule('src/config/affiliate-creatives.ts');
}
