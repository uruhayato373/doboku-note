...
function fixture(exam) {
  ...
  const category={cem:'pe-comprehensive-management','civil-1':'civil-construction-1','pe-construction':'pe-construction','pe-first-stage':'pe-first-stage'}[exam];
