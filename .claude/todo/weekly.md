...
| DN-0344 | 建設部門版を土台に、全部門共通版の範囲（部門に依存する例の分け方・上下水道の例）と価格・置き場を決めて着手する（公開期日 11/3） | 当方 |
...
| DN-0356 | 上下水道の資格の正式名称（技術士の部門・選択科目・取得年）と測量士の取得年を回答する | 回答後に当方がプロフィールと権威性バナーを直す |
