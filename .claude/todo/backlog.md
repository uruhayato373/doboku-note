...
### [DN-0213] 資格別の事業方針・KPI・週次月次改善を管理画面と共通運用へ統合する
タグ: [インフラ・計測] [種類:改善] [検証:check-business-direction] [起票:2026-09-13] [進行中]

資格別の学習価値・図解・収益・運営負担を共通の方針と計測定義へ統合する。実装契約は [計画](../plans/DN-0213-business-direction.md)。
