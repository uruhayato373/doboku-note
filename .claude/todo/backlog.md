...
### [DN-0322] 合格発表後に資格ポートフォリオを見直し、候補資格の昇格・見送りを決める
タグ: [収益化] [領域:戦略] [時期:2027-01..2027-03] [種類:意思決定] [起票:2026-09-26]

**起点**: 候補資格は資格一覧（管理画面 戦略 ＞ 資格一覧）で管理している。合格発表が出そろう時期に、展開中の資格の成果と候補資格の需要を見て、昇格・見送りを1回だけ判断する。（2026-09-26 に年間ロードマップの重点をバックログへ一本化したときに起票）

**完了条件**: qualification-registry.json の portfolio を更新し、判断の理由を月次レビューに残したら、このカードを削除する。
