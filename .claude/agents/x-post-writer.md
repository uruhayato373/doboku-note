...
| Kindle | `scripts/kindle-published/catalog.json`で`status: live`かつASIN確認済みの書籍。g-01 / g-02は発売中と書ける | カタログが`ready` / `in_review`の書籍を発売中と書くこと。note商品は`note-magazines.ts`が`published:true`かつライブURL設定済みの場合だけ販売中と書く |
