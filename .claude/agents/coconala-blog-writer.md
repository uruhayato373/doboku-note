...
`content/coconala/blog/{slug}/article.md` を1本ずつ執筆する **Generator エージェント**。
...
| パラメータ | 例 | 説明 |
|---|---|---|
| `slug` | `ochiru-keiken-kijutsu-3-pattern` | 出力先 `content/coconala/blog/{slug}/article.md` |
...
| `source` | `content/note/1級・2級土木/経験記述-落ちる答案診断-無料/article.md` | 素材（原稿ではない） |
...
`content/coconala/blog/{slug}/article.md` を作成する。
...
source: content/note/1級・2級土木/経験記述-落ちる答案診断-無料/article.md
---
