...
`content/site/civil-construction-1/secondary-{r03,r04,r05,r06,r07}/article.mdx` の 5 本は、問題文だけが並んでおり、解答・解説が**完全に空白**。AdSense ガイドラインの「価値の低いコンテンツ」「無断複製コンテンツ」判定の典型。
...
```json
{
  ...
  "files_changed": ["content/site/civil-construction-1/secondary-r05/article.mdx"],
...
- `content/site/civil-construction-1/secondary-concrete-past-problems/article.mdx` — 解答スタイルの参考実装
- `content/site/civil-construction-1/secondary-earthwork-past-problems/article.mdx` — 解答スタイルの参考実装
