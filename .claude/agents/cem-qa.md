...
**加重スコア計算**: 合計 = Σ(各軸スコア × 重み) / 3

例: 構造3・モバイル2・原則3・参考2・関連3 → (3×0.30 + 2×0.25 + 3×0.20 + 2×0.15 + 3×0.10) / 3 = 2.60 / 3 = 0.87 → **要修正**
合格例: 構造3・モバイル3・原則2・参考2・関連2 → 2.40 / 3 = 0.80 → **合格**（2.0 以上は加重前スコア）
