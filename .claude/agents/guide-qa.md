...
| コマンド | 用途 |
|---|---|
| `node .claude/scripts/lint-mdx-mobile.mjs <mdx>` | 6-1〜6-4（見出し直下の導入文なし）・15-1/15-2（文末単調・文長）・12-x（ガイド末尾構造）・7-1（太字スコープ）の機械根拠 |
...
| 軸 | 重み | 3点 | 2点 | 1点 | 0点 |
|---|---|---|---|---|---|
| **導入の質**（§26 リード文 + §2/§8/§17-2 見出し直下） | 25% | 冒頭が読者ベネフィット型リード（共感→この記事でわかること→結論ファースト）、冒頭 Callout なし、全 H2/H3 直下に導入文あり（lint 6-1〜6-4 ゼロ） | リード文は妥当だが弱い or 6-1〜6-4 が 1〜2 件 | 冒頭がいきなり Callout/箇条書き or 6-1〜6-4 が 3〜5 件 | リード文が概念定義ファースト（キーワード型の流用）or 6-1〜6-4 が 6 件以上 |
...
2. **機械チェック**: lint-mdx-mobile（6-1〜6-4 / 15-1/15-2 / 12-x / 7-1）と check-guide-length（文字数）を読み、軸別に HIGH/MEDIUM/LOW を分類。
