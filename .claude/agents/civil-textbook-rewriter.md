...
- ❌ `<ArticleImage>` の caption に長文の説明を書く（真実源: `.claude/content-principles.md` §8、`auto memory/feedback_article_image_caption.md`）
...
- `.claude/content-principles.md` — コンテンツ原則の真実源（特に §5: ExamPoint, §8: ArticleImage caption, §9: 参考資料）
