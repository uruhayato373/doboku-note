...
| ファイル | 用途 |
|---|---|
| `content/sources/textbook/技術士第一次試験/{R##}/{R##}-正答.pdf` | 正答番号表（テキスト抽出可） |
| `content/sources/textbook/技術士第一次試験/{R##}/{R##}-適性.pdf` | 適性科目問題（画像ベース） |
| `content/sources/textbook/技術士第一次試験/{R##}/{R##}-基礎.pdf` | 基礎科目問題（画像ベース） |
| `content/sources/textbook/技術士第一次試験/{R##}/{R##}-建設.pdf` | 専門科目(建設)問題（画像ベース） |
| `content/site/pe-first-stage/{year}-{sub}/article.mdx` | 監査対象 MDX |
...
- `content/sources/textbook/技術士第一次試験/` — ソース PDF
