...
>
> - 採点: [`docs/editorial/02_採点ルーブリック方針.md`](../../../../../docs/editorial/02_採点ルーブリック方針.md)
> - リライト: [`docs/editorial/03_リライト方法論方針.md`](../../../../../docs/editorial/03_リライト方法論方針.md)

## 対象

- **カテゴリ**: `pe-comprehensive-management`
- **対象ファイル**: `content/site/pe-comprehensive-management/{slug}/article.mdx`
- **対象件数**: ~690 件（キーワードページ）
...
- Step 1-7: 既存 lint・5軸採点フロー（[02_採点ルーブリック方針.md](../../../../../docs/editorial/02_採点ルーブリック方針.md) 参照）
...
弱点軸 → 推奨拡張パターン A-G の選択ロジックは `scripts-cem/quality-cycle.mjs` の `pickPatterns()` に実装済み（真実源は [03_リライト方法論方針.md](../../../../../docs/editorial/03_リライト方法論方針.md)）。
