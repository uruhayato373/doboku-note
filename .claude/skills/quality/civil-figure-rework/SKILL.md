...
- `content/sources/textbook/１級土木施工管理技士/R{年}-1ji-{AB}.pdf` が存在
- `content/site/civil-construction-1/primary-r{年}-{ab}/article.mdx` が存在
...
pdftoppm -r 200 -png "content/sources/textbook/１級土木施工管理技士/過去問/R06/R06_第一次検定_問題A.pdf" .tmp/pdf-pages/R6-1ji-A/page

mkdir -p .tmp/pdf-text
pdftotext -layout "content/sources/textbook/１級土木施工管理技士/過去問/R06/R06_第一次検定_問題A.pdf" .tmp/pdf-text/R6-1ji-A.txt
```
...
mv content/site/civil-construction-1/primary-r06-a/img/*.png .tmp/backup/r06-a/img/ 2>/dev/null || true
mv content/site/civil-construction-1/primary-r06-a/img/*.webp .tmp/backup/r06-a/img/ 2>/dev/null || true
```
...
node .claude/skills/quality/civil-figure-rework/scripts/run-crop.mjs \
  ...
  --out-dir content/site/civil-construction-1/primary-r06-a/img
```
...
node .claude/skills/quality/civil-figure-rework/scripts/inject-img-mdx.mjs \
  --mdx content/site/civil-construction-1/primary-r06-a/article.mdx \
  --spec .tmp/r06-a-figure-spec.json
```
...
git add content/site/civil-construction-1/primary-r06-a/article.mdx
git add content/site/civil-construction-1/primary-r06-a/img/
...
- **更新 MDX**: `content/site/civil-construction-1/primary-{exam}/article.mdx`
- **新規/更新 PNG**: `content/site/civil-construction-1/primary-{exam}/img/*.png`
- **生成 WEBP**: `content/site/civil-construction-1/primary-{exam}/img/*.webp`（CI が R2 自動同期）
...
- `.claude/knowledge/reference/image-policy.md` L165-177 — 過去問図 caption/alt 厳格ルール
- `.claude/knowledge/reference/agents-registry.md` L71-96 — Generator/Evaluator 分業原則
