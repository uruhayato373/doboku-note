...
- **設問3はペルソナ一貫性の例外＝国家スケールで書く**: 近年（R06・R07〜）の必須科目 設問3 は「事業や組織の枠を超え、我が国が解決すべき課題と施策」を要求する。ここでは設問1・2 で固定したペルソナ（事業・組織・業界）の視点を **意図的に離れ**、我が国＝国家レベルの課題と施策を論じる。少子高齢化等のテーマの進行そのものを広く課題として設定してよい。
  - 特定業界に閉じた施策（例: 建設業界の構造改革、業界 DX 共通基盤、道路インフラ集約）は「事業の枠 → 業界の枠」へ一段広げただけで要求スケールに届かず、最重視される「視点の広さ」で減点される
  - 施策は **労働力人口の確保（女性・高齢者・外国人材）・出生率対策・全産業の生産性革命・社会保障の持続可能性** などペルソナ非依存の国家政策で立てる。全属性版が設問3でほぼ同じ国家施策に収束してよい
  - ②は世界情勢・経済財政/厚生労働政策の動向・予算制約の背景に、③は総監5管理に限らない国家的重要課題の視点に触れる
