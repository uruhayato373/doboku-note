...
| 図を公開R2に出してしまう懸念 | `content/sources/textbook/**/img` は r2-sync 対象外。かつ 2026-08-27〜 README.md 以外 git 追跡外＝実体は Drive vault（`doboku-note/文字起こし/`）のみ（公開されない。生成後は vault へコピーして永続化） |
