...
明示起動する）。実装・設計の真実源は
[docs/operations/gsc-ga4-playwright-automation-spec.md](../../../../docs/operations/gsc-ga4-playwright-automation-spec.md)。
...
- 実装指示書: `docs/operations/gsc-ga4-playwright-automation-spec.md`
