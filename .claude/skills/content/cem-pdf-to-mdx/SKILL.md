...
択一式過去問を変換する際は、以下の構造を**厳守**すること。

```mdx
---
title: "技術士二次試験 総合技術監理部門 令和X年度 択一式"
type: 技術基準
...
<RelatedKeywords items={[
  { label: "キーワード1", slug: "keyword-1-slug" },
  { label: "キーワード2", slug: "keyword-2-slug" },
]} />
...
**構造ルール:**
1. **設問番号は `## Ⅰ-1-X`（H2）** — TOCに表示される唯一の見出し
2. **`toc_max_heading_level: 2`** — frontmatterに必須。H3以下をTOCから除外
