 ...
 *                 content/sns/instagram/{exam}/exam-packs/<year>/pack-<NN>/ から読む
 ...
 *
 * 出力先:
 *   --slug: content/sns/instagram/{date}-{slug}/{reels,carousel}/img/
 *   --exam: content/sns/instagram/{exam}/exam-packs/{year}/pack-{NN}/{reels,carousel}/img/
 *
 * 関連スキル:
...
if (mode === 'exam') {
  ...
  const mdx = extractMdx({ category, slug, root: resolve(ROOT, 'content/site') });
