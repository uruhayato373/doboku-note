...
| 過去問 slide-data SoT | `content/sns/instagram/{exam}/exam-packs/<year>/pack-<NN>/slide-data.json` |
...
# → content/sns/instagram/cem/exam-packs/r07/pack-{01..09}/slide-data.json
...
# 場所: content/sns/<channel>/draft/<NNN>-クイズ-...-/source.md
# フォーマットは content/sns/instagram/_dev/source.md 参照

# 2. レンダリング
node .claude/scripts/sns/render-quiz-pack.mjs content/sns/<channel>/draft/<NNN>-...
...
- ソース: `content/sns/instagram/_dev/source.md`
- 出力: `content/sns/instagram/_dev/instagram-carousel/img/01-経済性/{01..10}.png`
...
- 出力: `content/sns/instagram/{date}-{slug}/{reels,carousel}/img/`
- 構造: cover + board (定義) + figure (図解 任意) + board (応用) + board (試験ポイント) + cta = 6 枚程度
- データ: `content/site/pe-comprehensive-management/<slug>/article.mdx` から自動抽出
