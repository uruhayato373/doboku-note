 ...
 *
 * スキャン対象:
 *   - content/sns/instagram/highlights/<NN_*>/slide-data.json
 *   - content/sns/instagram/{exam}/exam-packs/<year>/pack-<NN>/slide-data.json
 *   - content/sns/instagram/highlights/highlight-materials/ (旧パスはスキップ)
 *
 * Usage:
