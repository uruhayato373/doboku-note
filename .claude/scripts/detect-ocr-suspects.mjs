...
/**
 * 過去問 MDX のパスを列挙する。
 * - 総監: .local/r2/posts/pe-comprehensive-management/{h|r}\d+-(primary|secondary)/article.mdx
 * - 1級土木: .local/r2/posts/civil-construction-1/(primary|secondary)-<year>-<x>/article.mdx
 */
