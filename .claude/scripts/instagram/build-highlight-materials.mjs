 ...
 *
 * 戦略: docs/marketing/01_SNS集客戦略.md v7.1 §2 Highlight 6 種
 * ポリシー: .claude/knowledge/reference/ig-stories-policy.md §5 系統 A / C
 *
 * 対応ハイライト (戦略 v7.1 §2 のハイライト 1〜6 種の順序):
 *   - content/sns/instagram/highlights/01_intro/             まず読む
 *   - content/sns/instagram/highlights/02_carousel-index/    カルーセル目次
 *   - content/sns/instagram/highlights/03_reels-roundup/     Reels まとめ
 *   - content/sns/instagram/highlights/04_faq/               FAQ
 *   - content/sns/instagram/highlights/05_announcement/      お知らせ（テンプレ）
 *   - content/sns/instagram/highlights/06_materials/         教材 (系統 C)
 *
 * Usage:
 *   # 単一ハイライト
 *   node .claude/scripts/instagram/build-highlight-materials.mjs --dir content/sns/instagram/highlights/04_faq
