#!/usr/bin/env node
// note 公開ドラフト（docs/note/{slug}/article.md）内の `[anchor](URL)` について、
...
// pe-chapters.json に未登録のスラッグは、`.local/r2/posts/.../article.mdx`
// の frontmatter title を fallback で読む（pillar / hub / cross-cutting 等）
function loadFrontmatterTitle(slug) {
  const p = resolve(`.local/r2/posts/pe-comprehensive-management/${slug}/article.mdx`);
