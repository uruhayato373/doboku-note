...
| [exam-content-policy.md](./exam-content-policy.md) | 試験別コンテンツ整備方針（整備方針差分表・執筆判断ガイド）+ コンテンツ別レビュー視点（レビュー視点表）+ 新資格追加手順 | PDF→MDX 変換・品質レビュー時（`/verify-pdf-mdx`, `/civil-construction-1-pdf-to-mdx`, `/cem-pdf-to-mdx` 等） |
...
- **コンテンツ品質ルール変更時** → `.claude/content-principles.md`（真実源）をまず更新し、`content-authoring.md` は参照として揃える
