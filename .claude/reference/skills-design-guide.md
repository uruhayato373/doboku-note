...
- [ ] 既存スキルとの重複を確認した（`.claude/reference/skills-registry.md` を grep）
...
- [ ] `.claude/reference/skills-registry.md` の該当カテゴリに追記
- [ ] 関連スキルの `参照` セクションを更新
...
`.claude/reference/skills-registry.md` に以下を記載:
...
- `git rm` で削除
- `.claude/reference/skills-registry.md` に「退役」として削除日と理由を記載
...
- **Registry**: `.claude/reference/skills-registry.md`
- **Agents Registry**: `.claude/reference/agents-registry.md`
