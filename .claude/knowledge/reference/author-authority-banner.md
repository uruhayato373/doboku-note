...
| ファイル | 役割 |
|---|---|
| `content/note/共通/著者オーソリティ/img/base-keyart.png` | ChatGPT 生成の文字なしキーアート（1672×941・16:9・橋＝架／5管理ヘキサゴン／ヘルメット・図面・赤チェック＝採点） |
| `content/note/共通/著者オーソリティ/img/figure-author-authority.png` | 完成バナー（キーアート左1/3に日本語コピーを合成） |
