...
系統 A の 6 種目に対応する Stories シリーズ。雛形は `content/sns/instagram/highlights/06_materials/` に。他の 5 種も `content/sns/instagram/highlights/{01_intro, 02_carousel-index, 03_reels-roundup, 04_faq, 05_announcement}/` に整備済み（数値プレフィックスは戦略 v7.1 §2 の 1〜6 種の順序に対応）。
