...
関連: [CHARACTER-SPEC.md](../../../content/sns/_assets/character/CHARACTER-SPEC.md)（設定書）／[ig-reels-policy.md](ig-reels-policy.md)（リール合成）／[sns-image-policy.md](sns-image-policy.md)（SNS 画像）
